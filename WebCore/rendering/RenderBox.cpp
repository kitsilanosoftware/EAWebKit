...
//+EAWebKitChange
//8/28/2012 Pulled in newer version from the safari-536.26-branch to fix a translucency issue with transformed images.
void RenderBox::paintMaskImages(const PaintInfo& paintInfo, const LayoutRect& paintRect)
{
    ...
    if (!compositedMask || flattenCompositingLayers) {
        ...
        paintInfo.context->beginTransparencyLayer(1.f);
