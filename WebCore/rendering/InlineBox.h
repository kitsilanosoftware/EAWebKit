...
public:
    ...
    int pixelSnappedLogicalLeft() const { return (int)logicalLeft(); }
    int pixelSnappedLogicalRight() const { return (int)ceilf(logicalRight()); }

    // The logicalTop[ position is the top edge of the line box in a horizontal line and the left edge in a vertical line.
    LayoutUnit logicalTop() const { return (LayoutUnit)(isHorizontal() ? m_topLeft.y() : m_topLeft.x()); }
    LayoutUnit logicalBottom() const { return (LayoutUnit) (logicalTop() + logicalHeight()); }
