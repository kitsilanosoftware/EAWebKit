...
//+EAWebKitChange
//7/9/2012
// Added few explicit casts in this file to avoid warnings
//-EAWebKitChange
...
public:
    ...
    LayoutUnit logicalLeftLayoutOverflow() const { return (LayoutUnit)(m_overflow ? (isHorizontal() ? m_overflow->minXLayoutOverflow() : m_overflow->minYLayoutOverflow()) : logicalLeft()); }
    LayoutUnit logicalRightLayoutOverflow() const { return (LayoutUnit)(m_overflow ? (isHorizontal() ? m_overflow->maxXLayoutOverflow() : m_overflow->maxYLayoutOverflow()) : ceilf(logicalRight())); }
    ...
    LayoutUnit logicalLeftVisualOverflow() const { return (LayoutUnit) (m_overflow ? (isHorizontal() ? m_overflow->minXVisualOverflow() : m_overflow->minYVisualOverflow()) : logicalLeft()); }
    LayoutUnit logicalRightVisualOverflow() const { return (LayoutUnit) (m_overflow ? (isHorizontal() ? m_overflow->maxXVisualOverflow() : m_overflow->maxYVisualOverflow()) : ceilf(logicalRight())); }
