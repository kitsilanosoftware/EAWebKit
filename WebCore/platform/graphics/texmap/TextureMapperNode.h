...
private:
    ...
    FloatSize contentSize() const
    {
		//+EAWebKitChange
		//10/17/2012
		//It does not seem to make sense to special case content size to image size as it will not be correct in the presence of scaling. And 
		//we end up with an incorrect layer/texture size.
		return m_size;
	...
	//+EAWebKitChange
	//8/27/2012
	FloatRect m_tileLastRecomputeRect;
	//-EAWebKitChange
    float m_opacity;
    String m_name;
