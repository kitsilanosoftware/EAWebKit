...
//+EAWebKitChange - Fix for updating the image content (e.g image changed on mouse over) so that it is repainted to the layer in the TextureMapperNode::renderContent. 
//1/3/2013
    m_pendingContent.needsDisplay = true;
//-EAWebKitChange
