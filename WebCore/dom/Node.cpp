...
//+EAWebKitChange
//12/7/2011 - Wrapped a global static inside a function and leak so that the destructor does not run.
static HashSet<Node*>* spIgnoreSet = NULL;
static HashSet<Node*>& ignoreSet()
{
	if(!spIgnoreSet)
		spIgnoreSet = new HashSet<Node*>();
	return *spIgnoreSet;
}
//-EAWebKitChange
#endif
