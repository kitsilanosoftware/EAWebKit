...
public:
    ...
    {
        JSHTMLFieldSetElementConstructor* ptr = new (JSC::allocateCell<JSHTMLFieldSetElementConstructor>(*exec->heap())) JSHTMLFieldSetElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLFieldSetElementPrototype::s_info = { "HTMLFieldSetElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLFieldSetElementPrototypeTable, 0 };
