...
public:
    ...
    {
        JSSQLExceptionConstructor* ptr = new (JSC::allocateCell<JSSQLExceptionConstructor>(*exec->heap())) JSSQLExceptionConstructor(structure, globalObject);
...
const ClassInfo JSSQLExceptionPrototype::s_info = { "SQLExceptionPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSSQLExceptionPrototypeTable };
