...
public:
    ...
    {
        JSSpeechInputResultList* ptr = new (JSC::allocateCell<JSSpeechInputResultList>(globalObject->globalData().heap)) JSSpeechInputResultList(structure, globalObject, impl);
...
public:
    ...
    {
        JSSpeechInputResultListPrototype* ptr = new (JSC::allocateCell<JSSpeechInputResultListPrototype>(globalData.heap)) JSSpeechInputResultListPrototype(globalData, globalObject, structure);
