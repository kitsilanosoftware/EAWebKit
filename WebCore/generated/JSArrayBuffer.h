...
public:
    ...
    {
        JSArrayBuffer* ptr = new (JSC::allocateCell<JSArrayBuffer>(globalObject->globalData().heap)) JSArrayBuffer(structure, globalObject, impl);
...
public:
    ...
    {
        JSArrayBufferPrototype* ptr = new (JSC::allocateCell<JSArrayBufferPrototype>(globalData.heap)) JSArrayBufferPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSArrayBufferConstructor* ptr = new (JSC::allocateCell<JSArrayBufferConstructor>(*exec->heap())) JSArrayBufferConstructor(structure, globalObject);
