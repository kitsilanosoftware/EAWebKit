...
public:
    ...
    {
        JSDirectoryEntrySyncConstructor* ptr = new (JSC::allocateCell<JSDirectoryEntrySyncConstructor>(*exec->heap())) JSDirectoryEntrySyncConstructor(structure, globalObject);
...
const ClassInfo JSDirectoryEntrySyncPrototype::s_info = { "DirectoryEntrySyncPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSDirectoryEntrySyncPrototypeTable };
