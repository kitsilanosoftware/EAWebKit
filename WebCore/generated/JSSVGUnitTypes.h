...
public:
    ...
    {
        JSSVGUnitTypes* ptr = new (JSC::allocateCell<JSSVGUnitTypes>(globalObject->globalData().heap)) JSSVGUnitTypes(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGUnitTypesPrototype* ptr = new (JSC::allocateCell<JSSVGUnitTypesPrototype>(globalData.heap)) JSSVGUnitTypesPrototype(globalData, globalObject, structure);
