...
public:
    ...
    {
        JSSVGAnimatedBooleanConstructor* ptr = new (JSC::allocateCell<JSSVGAnimatedBooleanConstructor>(*exec->heap())) JSSVGAnimatedBooleanConstructor(structure, globalObject);
...
const ClassInfo JSSVGAnimatedBooleanPrototype::s_info = { "SVGAnimatedBooleanPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGAnimatedBooleanPrototypeTable, 0 };
...
void setJSSVGAnimatedBooleanBaseVal(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    SVGAnimatedBoolean* imp = static_cast<SVGAnimatedBoolean*>(castedThis->impl());
    ExceptionCode ec = 0;
    imp->setBaseVal(value.toBoolean(exec), ec);
