...
public:
    ...
    {
        JSSVGTitleElement* ptr = new (JSC::allocateCell<JSSVGTitleElement>(globalObject->globalData().heap)) JSSVGTitleElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGTitleElementPrototype* ptr = new (JSC::allocateCell<JSSVGTitleElementPrototype>(globalData.heap)) JSSVGTitleElementPrototype(globalData, globalObject, structure);
