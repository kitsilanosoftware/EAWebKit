...
public:
    ...
    {
        JSCSSValueConstructor* ptr = new (JSC::allocateCell<JSCSSValueConstructor>(*exec->heap())) JSCSSValueConstructor(structure, globalObject);
...
const ClassInfo JSCSSValuePrototype::s_info = { "CSSValuePrototype", &JSC::JSNonFinalObject::s_info, &JSCSSValuePrototypeTable, 0 };
