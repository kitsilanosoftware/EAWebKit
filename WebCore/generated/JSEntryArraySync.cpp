...
public:
    ...
    {
        JSEntryArraySyncConstructor* ptr = new (JSC::allocateCell<JSEntryArraySyncConstructor>(*exec->heap())) JSEntryArraySyncConstructor(structure, globalObject);
...
const ClassInfo JSEntryArraySyncPrototype::s_info = { "EntryArraySyncPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSEntryArraySyncPrototypeTable };
