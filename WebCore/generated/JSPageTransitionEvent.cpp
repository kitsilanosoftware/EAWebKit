...
ConstructType JSPageTransitionEventConstructor::getConstructData(ConstructData& constructData)
{
...
const ClassInfo JSPageTransitionEventPrototype::s_info = { "PageTransitionEventPrototype", &JSC::JSNonFinalObject::s_info, &JSPageTransitionEventPrototypeTable, 0 };
