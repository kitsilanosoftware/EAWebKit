...
public:
    ...
    {
        JSDirectoryReaderSyncConstructor* ptr = new (JSC::allocateCell<JSDirectoryReaderSyncConstructor>(*exec->heap())) JSDirectoryReaderSyncConstructor(structure, globalObject);
...
const ClassInfo JSDirectoryReaderSyncPrototype::s_info = { "DirectoryReaderSyncPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSDirectoryReaderSyncPrototypeTable };
