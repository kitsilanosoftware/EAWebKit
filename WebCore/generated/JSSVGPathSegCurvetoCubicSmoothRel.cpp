...
public:
    ...
    {
        JSSVGPathSegCurvetoCubicSmoothRelConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegCurvetoCubicSmoothRelConstructor>(*exec->heap())) JSSVGPathSegCurvetoCubicSmoothRelConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegCurvetoCubicSmoothRelPrototype::s_info = { "SVGPathSegCurvetoCubicSmoothRelPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegCurvetoCubicSmoothRelPrototypeTable, 0 };
