...
public:
    ...
    {
        JSFileConstructor* ptr = new (JSC::allocateCell<JSFileConstructor>(*exec->heap())) JSFileConstructor(structure, globalObject);
...
const ClassInfo JSFilePrototype::s_info = { "FilePrototype", &JSC::JSNonFinalObject::s_info, 0, getJSFilePrototypeTable };
