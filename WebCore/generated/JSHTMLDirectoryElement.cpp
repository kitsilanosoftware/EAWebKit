...
public:
    ...
    {
        JSHTMLDirectoryElementConstructor* ptr = new (JSC::allocateCell<JSHTMLDirectoryElementConstructor>(*exec->heap())) JSHTMLDirectoryElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLDirectoryElementPrototype::s_info = { "HTMLDirectoryElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLDirectoryElementPrototypeTable, 0 };
