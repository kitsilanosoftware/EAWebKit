...
public:
    ...
    {
        JSHTMLTableSectionElementConstructor* ptr = new (JSC::allocateCell<JSHTMLTableSectionElementConstructor>(*exec->heap())) JSHTMLTableSectionElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLTableSectionElementPrototype::s_info = { "HTMLTableSectionElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLTableSectionElementPrototypeTable, 0 };
