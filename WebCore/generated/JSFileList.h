...
public:
    ...
    {
        JSFileList* ptr = new (JSC::allocateCell<JSFileList>(globalObject->globalData().heap)) JSFileList(structure, globalObject, impl);
...
public:
    ...
    {
        JSFileListPrototype* ptr = new (JSC::allocateCell<JSFileListPrototype>(globalData.heap)) JSFileListPrototype(globalData, globalObject, structure);
