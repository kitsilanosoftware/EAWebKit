...
public:
    ...
    {
        JSWebGLContextEvent* ptr = new (JSC::allocateCell<JSWebGLContextEvent>(globalObject->globalData().heap)) JSWebGLContextEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSWebGLContextEventPrototype* ptr = new (JSC::allocateCell<JSWebGLContextEventPrototype>(globalData.heap)) JSWebGLContextEventPrototype(globalData, globalObject, structure);
