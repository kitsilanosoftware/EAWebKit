...
public:
    ...
    {
        JSCSSPrimitiveValueConstructor* ptr = new (JSC::allocateCell<JSCSSPrimitiveValueConstructor>(*exec->heap())) JSCSSPrimitiveValueConstructor(structure, globalObject);
...
const ClassInfo JSCSSPrimitiveValuePrototype::s_info = { "CSSPrimitiveValuePrototype", &JSC::JSNonFinalObject::s_info, &JSCSSPrimitiveValuePrototypeTable, 0 };
