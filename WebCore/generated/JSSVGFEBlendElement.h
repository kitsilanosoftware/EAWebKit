...
public:
    ...
    {
        JSSVGFEBlendElement* ptr = new (JSC::allocateCell<JSSVGFEBlendElement>(globalObject->globalData().heap)) JSSVGFEBlendElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGFEBlendElementPrototype* ptr = new (JSC::allocateCell<JSSVGFEBlendElementPrototype>(globalData.heap)) JSSVGFEBlendElementPrototype(globalData, globalObject, structure);
