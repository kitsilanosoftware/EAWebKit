...
public:
    ...
    {
        JSOESStandardDerivatives* ptr = new (JSC::allocateCell<JSOESStandardDerivatives>(globalObject->globalData().heap)) JSOESStandardDerivatives(structure, globalObject, impl);
...
public:
    ...
    {
        JSOESStandardDerivativesPrototype* ptr = new (JSC::allocateCell<JSOESStandardDerivativesPrototype>(globalData.heap)) JSOESStandardDerivativesPrototype(globalData, globalObject, structure);
