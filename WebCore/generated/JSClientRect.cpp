...
public:
    ...
    {
        JSClientRectConstructor* ptr = new (JSC::allocateCell<JSClientRectConstructor>(*exec->heap())) JSClientRectConstructor(structure, globalObject);
...
const ClassInfo JSClientRectPrototype::s_info = { "ClientRectPrototype", &JSC::JSNonFinalObject::s_info, &JSClientRectPrototypeTable, 0 };
