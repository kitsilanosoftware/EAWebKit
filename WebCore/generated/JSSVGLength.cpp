...
public:
    ...
    {
        JSSVGLengthConstructor* ptr = new (JSC::allocateCell<JSSVGLengthConstructor>(*exec->heap())) JSSVGLengthConstructor(structure, globalObject);
...
const ClassInfo JSSVGLengthPrototype::s_info = { "SVGLengthPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGLengthPrototypeTable, 0 };
