...
public:
    ...
    {
        JSDOMMimeTypeConstructor* ptr = new (JSC::allocateCell<JSDOMMimeTypeConstructor>(*exec->heap())) JSDOMMimeTypeConstructor(structure, globalObject);
...
const ClassInfo JSDOMMimeTypePrototype::s_info = { "MimeTypePrototype", &JSC::JSNonFinalObject::s_info, &JSDOMMimeTypePrototypeTable, 0 };
