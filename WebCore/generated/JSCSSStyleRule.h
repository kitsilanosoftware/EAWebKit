...
public:
    ...
    {
        JSCSSStyleRule* ptr = new (JSC::allocateCell<JSCSSStyleRule>(globalObject->globalData().heap)) JSCSSStyleRule(structure, globalObject, impl);
...
public:
    ...
    {
        JSCSSStyleRulePrototype* ptr = new (JSC::allocateCell<JSCSSStyleRulePrototype>(globalData.heap)) JSCSSStyleRulePrototype(globalData, globalObject, structure);
