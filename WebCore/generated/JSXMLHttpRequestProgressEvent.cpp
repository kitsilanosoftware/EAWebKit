...
public:
    ...
    {
        JSXMLHttpRequestProgressEventConstructor* ptr = new (JSC::allocateCell<JSXMLHttpRequestProgressEventConstructor>(*exec->heap())) JSXMLHttpRequestProgressEventConstructor(structure, globalObject);
...
const ClassInfo JSXMLHttpRequestProgressEventPrototype::s_info = { "XMLHttpRequestProgressEventPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSXMLHttpRequestProgressEventPrototypeTable };
