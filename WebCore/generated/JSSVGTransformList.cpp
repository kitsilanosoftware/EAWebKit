...
public:
    ...
    {
        JSSVGTransformListConstructor* ptr = new (JSC::allocateCell<JSSVGTransformListConstructor>(*exec->heap())) JSSVGTransformListConstructor(structure, globalObject);
...
const ClassInfo JSSVGTransformListPrototype::s_info = { "SVGTransformListPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGTransformListPrototypeTable, 0 };
