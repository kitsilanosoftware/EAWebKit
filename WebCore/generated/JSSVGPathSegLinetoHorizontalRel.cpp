...
public:
    ...
    {
        JSSVGPathSegLinetoHorizontalRelConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegLinetoHorizontalRelConstructor>(*exec->heap())) JSSVGPathSegLinetoHorizontalRelConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegLinetoHorizontalRelPrototype::s_info = { "SVGPathSegLinetoHorizontalRelPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegLinetoHorizontalRelPrototypeTable, 0 };
