...
public:
    ...
    {
        JSHTMLProgressElementConstructor* ptr = new (JSC::allocateCell<JSHTMLProgressElementConstructor>(*exec->heap())) JSHTMLProgressElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLProgressElementPrototype::s_info = { "HTMLProgressElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLProgressElementPrototypeTable, 0 };
