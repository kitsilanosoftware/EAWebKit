...
public:
    ...
    {
        JSSVGFilterElementConstructor* ptr = new (JSC::allocateCell<JSSVGFilterElementConstructor>(*exec->heap())) JSSVGFilterElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFilterElementPrototype::s_info = { "SVGFilterElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFilterElementPrototypeTable, 0 };
