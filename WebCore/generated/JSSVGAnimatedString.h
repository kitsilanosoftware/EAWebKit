...
public:
    ...
    {
        JSSVGAnimatedString* ptr = new (JSC::allocateCell<JSSVGAnimatedString>(globalObject->globalData().heap)) JSSVGAnimatedString(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnimatedStringPrototype* ptr = new (JSC::allocateCell<JSSVGAnimatedStringPrototype>(globalData.heap)) JSSVGAnimatedStringPrototype(globalData, globalObject, structure);
