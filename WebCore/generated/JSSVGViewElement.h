...
public:
    ...
    {
        JSSVGViewElement* ptr = new (JSC::allocateCell<JSSVGViewElement>(globalObject->globalData().heap)) JSSVGViewElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGViewElementPrototype* ptr = new (JSC::allocateCell<JSSVGViewElementPrototype>(globalData.heap)) JSSVGViewElementPrototype(globalData, globalObject, structure);
