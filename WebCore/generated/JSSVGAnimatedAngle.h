...
public:
    ...
    {
        JSSVGAnimatedAngle* ptr = new (JSC::allocateCell<JSSVGAnimatedAngle>(globalObject->globalData().heap)) JSSVGAnimatedAngle(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnimatedAnglePrototype* ptr = new (JSC::allocateCell<JSSVGAnimatedAnglePrototype>(globalData.heap)) JSSVGAnimatedAnglePrototype(globalData, globalObject, structure);
