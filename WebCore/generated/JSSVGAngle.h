...
public:
    ...
    {
        JSSVGAngle* ptr = new (JSC::allocateCell<JSSVGAngle>(globalObject->globalData().heap)) JSSVGAngle(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnglePrototype* ptr = new (JSC::allocateCell<JSSVGAnglePrototype>(globalData.heap)) JSSVGAnglePrototype(globalData, globalObject, structure);
