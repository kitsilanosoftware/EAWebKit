...
ConstructType JSEventConstructor::getConstructData(ConstructData& constructData)
{
...
const ClassInfo JSEventPrototype::s_info = { "EventPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSEventPrototypeTable };
