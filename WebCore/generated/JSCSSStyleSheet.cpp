...
public:
    ...
    {
        JSCSSStyleSheetConstructor* ptr = new (JSC::allocateCell<JSCSSStyleSheetConstructor>(*exec->heap())) JSCSSStyleSheetConstructor(structure, globalObject);
...
const ClassInfo JSCSSStyleSheetPrototype::s_info = { "CSSStyleSheetPrototype", &JSC::JSNonFinalObject::s_info, &JSCSSStyleSheetPrototypeTable, 0 };
