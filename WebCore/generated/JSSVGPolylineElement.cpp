...
public:
    ...
    {
        JSSVGPolylineElementConstructor* ptr = new (JSC::allocateCell<JSSVGPolylineElementConstructor>(*exec->heap())) JSSVGPolylineElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGPolylineElementPrototype::s_info = { "SVGPolylineElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPolylineElementPrototypeTable, 0 };
