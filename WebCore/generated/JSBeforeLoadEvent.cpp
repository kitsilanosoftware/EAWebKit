...
public:
    ...
    {
        JSBeforeLoadEventConstructor* ptr = new (JSC::allocateCell<JSBeforeLoadEventConstructor>(*exec->heap())) JSBeforeLoadEventConstructor(structure, globalObject);
...
const ClassInfo JSBeforeLoadEventPrototype::s_info = { "BeforeLoadEventPrototype", &JSC::JSNonFinalObject::s_info, &JSBeforeLoadEventPrototypeTable, 0 };
