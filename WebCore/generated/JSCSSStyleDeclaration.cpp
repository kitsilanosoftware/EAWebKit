...
public:
    ...
    {
        JSCSSStyleDeclarationConstructor* ptr = new (JSC::allocateCell<JSCSSStyleDeclarationConstructor>(*exec->heap())) JSCSSStyleDeclarationConstructor(structure, globalObject);
...
const ClassInfo JSCSSStyleDeclarationPrototype::s_info = { "CSSStyleDeclarationPrototype", &JSC::JSNonFinalObject::s_info, &JSCSSStyleDeclarationPrototypeTable, 0 };
...
void JSCSSStyleDeclaration::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSCSSStyleDeclarationPrototype::create(exec->globalData(), globalObject, JSCSSStyleDeclarationPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
