...
const ClassInfo JSSQLResultSetRowListPrototype::s_info = { "SQLResultSetRowListPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSSQLResultSetRowListPrototypeTable };
