...
public:
    ...
    {
        JSHTMLBaseFontElement* ptr = new (JSC::allocateCell<JSHTMLBaseFontElement>(globalObject->globalData().heap)) JSHTMLBaseFontElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLBaseFontElementPrototype* ptr = new (JSC::allocateCell<JSHTMLBaseFontElementPrototype>(globalData.heap)) JSHTMLBaseFontElementPrototype(globalData, globalObject, structure);
