...
public:
    ...
    {
        JSSVGAnimatedLengthList* ptr = new (JSC::allocateCell<JSSVGAnimatedLengthList>(globalObject->globalData().heap)) JSSVGAnimatedLengthList(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnimatedLengthListPrototype* ptr = new (JSC::allocateCell<JSSVGAnimatedLengthListPrototype>(globalData.heap)) JSSVGAnimatedLengthListPrototype(globalData, globalObject, structure);
