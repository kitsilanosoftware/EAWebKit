...
static const HashTableValue JSEventExceptionConstructorTableValues[] =
{
    ...
    { "DISPATCH_REQUEST_ERR", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsEventExceptionDISPATCH_REQUEST_ERR), (intptr_t)0 THUNK_GENERATOR(0) },
    { 0, 0, 0, 0 THUNK_GENERATOR(0) }
};

#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSEventExceptionConstructorTable = { 4, 3, JSEventExceptionConstructorTableValues, 0 };
...
public:
    ...
    {
        JSEventExceptionConstructor* ptr = new (JSC::allocateCell<JSEventExceptionConstructor>(*exec->heap())) JSEventExceptionConstructor(structure, globalObject);
...
#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSEventExceptionPrototypeTable = { 8, 7, JSEventExceptionPrototypeTableValues, 0 };
...
const ClassInfo JSEventExceptionPrototype::s_info = { "EventExceptionPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSEventExceptionPrototypeTable };
...
{
    return JSEventExceptionPrototype::create(exec->globalData(), globalObject, JSEventExceptionPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
JSValue jsEventExceptionDISPATCH_REQUEST_ERR(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
