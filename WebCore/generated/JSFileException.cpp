...
public:
    ...
    {
        JSFileExceptionConstructor* ptr = new (JSC::allocateCell<JSFileExceptionConstructor>(*exec->heap())) JSFileExceptionConstructor(structure, globalObject);
...
const ClassInfo JSFileExceptionPrototype::s_info = { "FileExceptionPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSFileExceptionPrototypeTable };
