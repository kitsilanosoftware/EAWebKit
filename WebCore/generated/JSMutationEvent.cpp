...
public:
    ...
    {
        JSMutationEventConstructor* ptr = new (JSC::allocateCell<JSMutationEventConstructor>(*exec->heap())) JSMutationEventConstructor(structure, globalObject);
...
const ClassInfo JSMutationEventPrototype::s_info = { "MutationEventPrototype", &JSC::JSNonFinalObject::s_info, &JSMutationEventPrototypeTable, 0 };
