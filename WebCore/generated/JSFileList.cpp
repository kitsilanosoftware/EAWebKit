...
public:
    ...
    {
        JSFileListConstructor* ptr = new (JSC::allocateCell<JSFileListConstructor>(*exec->heap())) JSFileListConstructor(structure, globalObject);
...
const ClassInfo JSFileListPrototype::s_info = { "FileListPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSFileListPrototypeTable };
