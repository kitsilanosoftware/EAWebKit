...
public:
    ...
    {
        JSSVGPathSegClosePathConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegClosePathConstructor>(*exec->heap())) JSSVGPathSegClosePathConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegClosePathPrototype::s_info = { "SVGPathSegClosePathPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegClosePathPrototypeTable, 0 };
