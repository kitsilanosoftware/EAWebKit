...
public:
    ...
    {
        JSXMLSerializer* ptr = new (JSC::allocateCell<JSXMLSerializer>(globalObject->globalData().heap)) JSXMLSerializer(structure, globalObject, impl);
...
public:
    ...
    {
        JSXMLSerializerPrototype* ptr = new (JSC::allocateCell<JSXMLSerializerPrototype>(globalData.heap)) JSXMLSerializerPrototype(globalData, globalObject, structure);
