...
public:
    ...
    {
        JSHTMLFieldSetElement* ptr = new (JSC::allocateCell<JSHTMLFieldSetElement>(globalObject->globalData().heap)) JSHTMLFieldSetElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLFieldSetElementPrototype* ptr = new (JSC::allocateCell<JSHTMLFieldSetElementPrototype>(globalData.heap)) JSHTMLFieldSetElementPrototype(globalData, globalObject, structure);
