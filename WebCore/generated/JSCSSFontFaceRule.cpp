...
public:
    ...
    {
        JSCSSFontFaceRuleConstructor* ptr = new (JSC::allocateCell<JSCSSFontFaceRuleConstructor>(*exec->heap())) JSCSSFontFaceRuleConstructor(structure, globalObject);
...
const ClassInfo JSCSSFontFaceRulePrototype::s_info = { "CSSFontFaceRulePrototype", &JSC::JSNonFinalObject::s_info, &JSCSSFontFaceRulePrototypeTable, 0 };
