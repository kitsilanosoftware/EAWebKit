...
public:
    ...
    {
        JSDOMTokenListConstructor* ptr = new (JSC::allocateCell<JSDOMTokenListConstructor>(*exec->heap())) JSDOMTokenListConstructor(structure, globalObject);
...
const ClassInfo JSDOMTokenListPrototype::s_info = { "DOMTokenListPrototype", &JSC::JSNonFinalObject::s_info, &JSDOMTokenListPrototypeTable, 0 };
