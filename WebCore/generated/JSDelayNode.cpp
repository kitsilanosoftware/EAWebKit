...
public:
    ...
    {
        JSDelayNodeConstructor* ptr = new (JSC::allocateCell<JSDelayNodeConstructor>(*exec->heap())) JSDelayNodeConstructor(structure, globalObject);
...
const ClassInfo JSDelayNodePrototype::s_info = { "DelayNodePrototype", &JSC::JSNonFinalObject::s_info, &JSDelayNodePrototypeTable, 0 };
