...
public:
    ...
    {
        JSSVGMaskElementConstructor* ptr = new (JSC::allocateCell<JSSVGMaskElementConstructor>(*exec->heap())) JSSVGMaskElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGMaskElementPrototype::s_info = { "SVGMaskElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGMaskElementPrototypeTable, 0 };
