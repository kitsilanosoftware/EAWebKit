...
public:
    ...
    {
        JSHTMLMenuElementConstructor* ptr = new (JSC::allocateCell<JSHTMLMenuElementConstructor>(*exec->heap())) JSHTMLMenuElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLMenuElementPrototype::s_info = { "HTMLMenuElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLMenuElementPrototypeTable, 0 };
