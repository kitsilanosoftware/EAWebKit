...
public:
    ...
    {
        JSSQLResultSet* ptr = new (JSC::allocateCell<JSSQLResultSet>(globalObject->globalData().heap)) JSSQLResultSet(structure, globalObject, impl);
...
public:
    ...
    {
        JSSQLResultSetPrototype* ptr = new (JSC::allocateCell<JSSQLResultSetPrototype>(globalData.heap)) JSSQLResultSetPrototype(globalData, globalObject, structure);
