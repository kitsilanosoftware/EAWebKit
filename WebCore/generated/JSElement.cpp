...
public:
    ...
    {
        JSElementConstructor* ptr = new (JSC::allocateCell<JSElementConstructor>(*exec->heap())) JSElementConstructor(structure, globalObject);
...
const ClassInfo JSElementPrototype::s_info = { "ElementPrototype", &JSC::JSNonFinalObject::s_info, &JSElementPrototypeTable, 0 };
