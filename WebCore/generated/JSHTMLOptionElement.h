...
public:
    ...
    {
        JSHTMLOptionElement* ptr = new (JSC::allocateCell<JSHTMLOptionElement>(globalObject->globalData().heap)) JSHTMLOptionElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLOptionElementPrototype* ptr = new (JSC::allocateCell<JSHTMLOptionElementPrototype>(globalData.heap)) JSHTMLOptionElementPrototype(globalData, globalObject, structure);
