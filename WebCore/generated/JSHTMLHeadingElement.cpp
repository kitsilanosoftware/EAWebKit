...
public:
    ...
    {
        JSHTMLHeadingElementConstructor* ptr = new (JSC::allocateCell<JSHTMLHeadingElementConstructor>(*exec->heap())) JSHTMLHeadingElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLHeadingElementPrototype::s_info = { "HTMLHeadingElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLHeadingElementPrototypeTable, 0 };
