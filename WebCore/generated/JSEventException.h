...
public:
    ...
    {
        JSEventException* ptr = new (JSC::allocateCell<JSEventException>(globalObject->globalData().heap)) JSEventException(structure, globalObject, impl);
...
public:
    ...
    {
        JSEventExceptionPrototype* ptr = new (JSC::allocateCell<JSEventExceptionPrototype>(globalData.heap)) JSEventExceptionPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsEventExceptionDISPATCH_REQUEST_ERR(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
