...
public:
    ...
    {
        JSRect* ptr = new (JSC::allocateCell<JSRect>(globalObject->globalData().heap)) JSRect(structure, globalObject, impl);
...
public:
    ...
    {
        JSRectPrototype* ptr = new (JSC::allocateCell<JSRectPrototype>(globalData.heap)) JSRectPrototype(globalData, globalObject, structure);
