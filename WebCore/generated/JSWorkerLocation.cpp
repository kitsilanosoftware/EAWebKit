...
public:
    ...
    {
        JSWorkerLocationConstructor* ptr = new (JSC::allocateCell<JSWorkerLocationConstructor>(*exec->heap())) JSWorkerLocationConstructor(structure, globalObject);
...
const ClassInfo JSWorkerLocationPrototype::s_info = { "WorkerLocationPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSWorkerLocationPrototypeTable };
