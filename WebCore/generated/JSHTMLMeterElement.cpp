...
public:
    ...
    {
        JSHTMLMeterElementConstructor* ptr = new (JSC::allocateCell<JSHTMLMeterElementConstructor>(*exec->heap())) JSHTMLMeterElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLMeterElementPrototype::s_info = { "HTMLMeterElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLMeterElementPrototypeTable, 0 };
