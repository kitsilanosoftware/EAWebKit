...
public:
    ...
    {
        JSSVGFontFaceFormatElementConstructor* ptr = new (JSC::allocateCell<JSSVGFontFaceFormatElementConstructor>(*exec->heap())) JSSVGFontFaceFormatElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFontFaceFormatElementPrototype::s_info = { "SVGFontFaceFormatElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFontFaceFormatElementPrototypeTable, 0 };
