...
static const HashTableValue JSHTMLTextAreaElementTableValues[] =
{
    ...
    { "selectionDirection", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLTextAreaElementSelectionDirection), (intptr_t)setJSHTMLTextAreaElementSelectionDirection THUNK_GENERATOR(0) },
...
public:
    ...
    {
        JSHTMLTextAreaElementConstructor* ptr = new (JSC::allocateCell<JSHTMLTextAreaElementConstructor>(*exec->heap())) JSHTMLTextAreaElementConstructor(structure, globalObject);
...
static const HashTableValue JSHTMLTextAreaElementPrototypeTableValues[] =
{
    ...
    { "setSelectionRange", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsHTMLTextAreaElementPrototypeFunctionSetSelectionRange), (intptr_t)3 THUNK_GENERATOR(0) },
    { 0, 0, 0, 0 THUNK_GENERATOR(0) }
};

#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSHTMLTextAreaElementPrototypeTable = { 9, 7, JSHTMLTextAreaElementPrototypeTableValues, 0 };
const ClassInfo JSHTMLTextAreaElementPrototype::s_info = { "HTMLTextAreaElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLTextAreaElementPrototypeTable, 0 };
...
JSValue jsHTMLTextAreaElementSelectionDirection(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    HTMLTextAreaElement* imp = static_cast<HTMLTextAreaElement*>(castedThis->impl());
    JSValue result = jsString(exec, imp->selectionDirection());
    return result;
}
...
void setJSHTMLTextAreaElementSelectionDirection(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLTextAreaElement* castedThis = static_cast<JSHTMLTextAreaElement*>(thisObject);
    HTMLTextAreaElement* imp = static_cast<HTMLTextAreaElement*>(castedThis->impl());
    imp->setSelectionDirection(ustringToString(value.toString(exec)));
}
...
EncodedJSValue JSC_HOST_CALL jsHTMLTextAreaElementPrototypeFunctionSetSelectionRange(ExecState* exec)
{
    ...
    const String& direction(ustringToString(exec->argument(2).toString(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
