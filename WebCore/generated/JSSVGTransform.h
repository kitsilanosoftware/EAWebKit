...
public:
    ...
    {
        JSSVGTransform* ptr = new (JSC::allocateCell<JSSVGTransform>(globalObject->globalData().heap)) JSSVGTransform(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGTransformPrototype* ptr = new (JSC::allocateCell<JSSVGTransformPrototype>(globalData.heap)) JSSVGTransformPrototype(globalData, globalObject, structure);
