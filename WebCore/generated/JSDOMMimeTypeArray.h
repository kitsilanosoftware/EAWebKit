...
public:
    ...
    {
        JSDOMMimeTypeArray* ptr = new (JSC::allocateCell<JSDOMMimeTypeArray>(globalObject->globalData().heap)) JSDOMMimeTypeArray(structure, globalObject, impl);
...
public:
    ...
    {
        JSDOMMimeTypeArrayPrototype* ptr = new (JSC::allocateCell<JSDOMMimeTypeArrayPrototype>(globalData.heap)) JSDOMMimeTypeArrayPrototype(globalData, globalObject, structure);
