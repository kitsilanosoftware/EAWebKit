...
public:
    ...
    {
        JSSVGPathSegLinetoAbsConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegLinetoAbsConstructor>(*exec->heap())) JSSVGPathSegLinetoAbsConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegLinetoAbsPrototype::s_info = { "SVGPathSegLinetoAbsPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegLinetoAbsPrototypeTable, 0 };
