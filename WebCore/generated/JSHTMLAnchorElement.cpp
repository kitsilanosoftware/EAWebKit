...
static const HashTableValue JSHTMLAnchorElementTableValues[] =
{
    ...
    { "download", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLAnchorElementDownload), (intptr_t)setJSHTMLAnchorElementDownload THUNK_GENERATOR(0) },
#endif
...
public:
    ...
    {
        JSHTMLAnchorElementConstructor* ptr = new (JSC::allocateCell<JSHTMLAnchorElementConstructor>(*exec->heap())) JSHTMLAnchorElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLAnchorElementPrototype::s_info = { "HTMLAnchorElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLAnchorElementPrototypeTable, 0 };
...
JSValue jsHTMLAnchorElementDownload(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    HTMLAnchorElement* imp = static_cast<HTMLAnchorElement*>(castedThis->impl());
    JSValue result = jsString(exec, imp->getAttribute(WebCore::HTMLNames::downloadAttr));
    return result;
}
...
void setJSHTMLAnchorElementDownload(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLAnchorElement* castedThis = static_cast<JSHTMLAnchorElement*>(thisObject);
    HTMLAnchorElement* imp = static_cast<HTMLAnchorElement*>(castedThis->impl());
    imp->setAttribute(WebCore::HTMLNames::downloadAttr, valueToStringWithNullCheck(exec, value));
}
