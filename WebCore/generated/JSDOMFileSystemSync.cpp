...
public:
    ...
    {
        JSDOMFileSystemSyncConstructor* ptr = new (JSC::allocateCell<JSDOMFileSystemSyncConstructor>(*exec->heap())) JSDOMFileSystemSyncConstructor(structure, globalObject);
...
const ClassInfo JSDOMFileSystemSyncPrototype::s_info = { "DOMFileSystemSyncPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSDOMFileSystemSyncPrototypeTable };
