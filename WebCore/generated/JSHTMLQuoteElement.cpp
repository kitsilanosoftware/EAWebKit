...
public:
    ...
    {
        JSHTMLQuoteElementConstructor* ptr = new (JSC::allocateCell<JSHTMLQuoteElementConstructor>(*exec->heap())) JSHTMLQuoteElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLQuoteElementPrototype::s_info = { "HTMLQuoteElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLQuoteElementPrototypeTable, 0 };
