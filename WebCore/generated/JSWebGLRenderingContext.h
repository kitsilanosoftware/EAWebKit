...
public:
    ...
    {
        JSWebGLRenderingContext* ptr = new (JSC::allocateCell<JSWebGLRenderingContext>(globalObject->globalData().heap)) JSWebGLRenderingContext(structure, globalObject, impl);
...
public:
    ...
    {
        JSWebGLRenderingContextPrototype* ptr = new (JSC::allocateCell<JSWebGLRenderingContextPrototype>(globalData.heap)) JSWebGLRenderingContextPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsWebGLRenderingContextDrawingBufferWidth(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsWebGLRenderingContextDrawingBufferHeight(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
