...
public:
    ...
    {
        JSSVGLengthList* ptr = new (JSC::allocateCell<JSSVGLengthList>(globalObject->globalData().heap)) JSSVGLengthList(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGLengthListPrototype* ptr = new (JSC::allocateCell<JSSVGLengthListPrototype>(globalData.heap)) JSSVGLengthListPrototype(globalData, globalObject, structure);
