...
public:
    ...
    {
        JSHTMLOptionsCollectionConstructor* ptr = new (JSC::allocateCell<JSHTMLOptionsCollectionConstructor>(*exec->heap())) JSHTMLOptionsCollectionConstructor(structure, globalObject);
...
const ClassInfo JSHTMLOptionsCollectionPrototype::s_info = { "HTMLOptionsCollectionPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLOptionsCollectionPrototypeTable, 0 };
