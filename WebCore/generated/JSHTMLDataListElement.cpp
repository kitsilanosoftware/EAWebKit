...
public:
    ...
    {
        JSHTMLDataListElementConstructor* ptr = new (JSC::allocateCell<JSHTMLDataListElementConstructor>(*exec->heap())) JSHTMLDataListElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLDataListElementPrototype::s_info = { "HTMLDataListElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLDataListElementPrototypeTable, 0 };
