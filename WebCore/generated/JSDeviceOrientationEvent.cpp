...
public:
    ...
    {
        JSDeviceOrientationEventConstructor* ptr = new (JSC::allocateCell<JSDeviceOrientationEventConstructor>(*exec->heap())) JSDeviceOrientationEventConstructor(structure, globalObject);
...
const ClassInfo JSDeviceOrientationEventPrototype::s_info = { "DeviceOrientationEventPrototype", &JSC::JSNonFinalObject::s_info, &JSDeviceOrientationEventPrototypeTable, 0 };
