...
public:
    ...
    {
        JSClipboardConstructor* ptr = new (JSC::allocateCell<JSClipboardConstructor>(*exec->heap())) JSClipboardConstructor(structure, globalObject);
...
const ClassInfo JSClipboardPrototype::s_info = { "ClipboardPrototype", &JSC::JSNonFinalObject::s_info, &JSClipboardPrototypeTable, 0 };
