...
public:
    ...
    {
        JSNodeFilterConstructor* ptr = new (JSC::allocateCell<JSNodeFilterConstructor>(*exec->heap())) JSNodeFilterConstructor(structure, globalObject);
...
const ClassInfo JSNodeFilterPrototype::s_info = { "NodeFilterPrototype", &JSC::JSNonFinalObject::s_info, &JSNodeFilterPrototypeTable, 0 };
