...
public:
    ...
    {
        JSHTMLStyleElementConstructor* ptr = new (JSC::allocateCell<JSHTMLStyleElementConstructor>(*exec->heap())) JSHTMLStyleElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLStyleElementPrototype::s_info = { "HTMLStyleElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLStyleElementPrototypeTable, 0 };
