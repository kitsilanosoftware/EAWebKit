...
public:
    ...
    {
        JSSVGForeignObjectElement* ptr = new (JSC::allocateCell<JSSVGForeignObjectElement>(globalObject->globalData().heap)) JSSVGForeignObjectElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGForeignObjectElementPrototype* ptr = new (JSC::allocateCell<JSSVGForeignObjectElementPrototype>(globalData.heap)) JSSVGForeignObjectElementPrototype(globalData, globalObject, structure);
