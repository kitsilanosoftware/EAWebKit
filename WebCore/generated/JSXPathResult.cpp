...
public:
    ...
    {
        JSXPathResultConstructor* ptr = new (JSC::allocateCell<JSXPathResultConstructor>(*exec->heap())) JSXPathResultConstructor(structure, globalObject);
...
const ClassInfo JSXPathResultPrototype::s_info = { "XPathResultPrototype", &JSC::JSNonFinalObject::s_info, &JSXPathResultPrototypeTable, 0 };
