...
public:
    ...
    {
        JSSVGTextPositioningElementConstructor* ptr = new (JSC::allocateCell<JSSVGTextPositioningElementConstructor>(*exec->heap())) JSSVGTextPositioningElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGTextPositioningElementPrototype::s_info = { "SVGTextPositioningElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGTextPositioningElementPrototypeTable, 0 };
