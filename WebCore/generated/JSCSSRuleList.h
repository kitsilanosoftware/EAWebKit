...
public:
    ...
    {
        JSCSSRuleList* ptr = new (JSC::allocateCell<JSCSSRuleList>(globalObject->globalData().heap)) JSCSSRuleList(structure, globalObject, impl);
...
public:
    ...
    {
        JSCSSRuleListPrototype* ptr = new (JSC::allocateCell<JSCSSRuleListPrototype>(globalData.heap)) JSCSSRuleListPrototype(globalData, globalObject, structure);
