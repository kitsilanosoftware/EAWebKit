...
public:
    ...
    {
        JSElement* ptr = new (JSC::allocateCell<JSElement>(globalObject->globalData().heap)) JSElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSElementPrototype* ptr = new (JSC::allocateCell<JSElementPrototype>(globalData.heap)) JSElementPrototype(globalData, globalObject, structure);
