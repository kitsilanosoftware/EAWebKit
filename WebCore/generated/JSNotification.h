...
public:
    ...
    {
        JSNotification* ptr = new (JSC::allocateCell<JSNotification>(globalObject->globalData().heap)) JSNotification(structure, globalObject, impl);
...
public:
    ...
    {
        JSNotificationPrototype* ptr = new (JSC::allocateCell<JSNotificationPrototype>(globalData.heap)) JSNotificationPrototype(globalData, globalObject, structure);
