...
public:
    ...
    {
        JSIDBKeyConstructor* ptr = new (JSC::allocateCell<JSIDBKeyConstructor>(*exec->heap())) JSIDBKeyConstructor(structure, globalObject);
...
const ClassInfo JSIDBKeyPrototype::s_info = { "IDBKeyPrototype", &JSC::JSNonFinalObject::s_info, &JSIDBKeyPrototypeTable, 0 };
