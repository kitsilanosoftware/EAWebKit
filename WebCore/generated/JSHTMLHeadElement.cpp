...
public:
    ...
    {
        JSHTMLHeadElementConstructor* ptr = new (JSC::allocateCell<JSHTMLHeadElementConstructor>(*exec->heap())) JSHTMLHeadElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLHeadElementPrototype::s_info = { "HTMLHeadElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLHeadElementPrototypeTable, 0 };
