...
public:
    ...
    {
        JSCanvasRenderingContextConstructor* ptr = new (JSC::allocateCell<JSCanvasRenderingContextConstructor>(*exec->heap())) JSCanvasRenderingContextConstructor(structure, globalObject);
...
const ClassInfo JSCanvasRenderingContextPrototype::s_info = { "CanvasRenderingContextPrototype", &JSC::JSNonFinalObject::s_info, &JSCanvasRenderingContextPrototypeTable, 0 };
