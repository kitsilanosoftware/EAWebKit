...
public:
    ...
    {
        JSSVGFEFuncBElementConstructor* ptr = new (JSC::allocateCell<JSSVGFEFuncBElementConstructor>(*exec->heap())) JSSVGFEFuncBElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFEFuncBElementPrototype::s_info = { "SVGFEFuncBElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFEFuncBElementPrototypeTable, 0 };
