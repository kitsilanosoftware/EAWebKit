...
{
    { "drawingBufferWidth", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsWebGLRenderingContextDrawingBufferWidth), (intptr_t)0 THUNK_GENERATOR(0) },
    { "drawingBufferHeight", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsWebGLRenderingContextDrawingBufferHeight), (intptr_t)0 THUNK_GENERATOR(0) },
...
static JSC_CONST_HASHTABLE HashTable JSWebGLRenderingContextTable = { 8, 7, JSWebGLRenderingContextTableValues, 0 };
...
public:
    ...
    {
        JSWebGLRenderingContextConstructor* ptr = new (JSC::allocateCell<JSWebGLRenderingContextConstructor>(*exec->heap())) JSWebGLRenderingContextConstructor(structure, globalObject);
...
const ClassInfo JSWebGLRenderingContextPrototype::s_info = { "WebGLRenderingContextPrototype", &JSC::JSNonFinalObject::s_info, &JSWebGLRenderingContextPrototypeTable, 0 };
...
JSValue jsWebGLRenderingContextDrawingBufferWidth(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSWebGLRenderingContext* castedThis = static_cast<JSWebGLRenderingContext*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    WebGLRenderingContext* imp = static_cast<WebGLRenderingContext*>(castedThis->impl());
    JSValue result = jsNumber(imp->drawingBufferWidth());
    return result;
}


JSValue jsWebGLRenderingContextDrawingBufferHeight(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSWebGLRenderingContext* castedThis = static_cast<JSWebGLRenderingContext*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    WebGLRenderingContext* imp = static_cast<WebGLRenderingContext*>(castedThis->impl());
    JSValue result = jsNumber(imp->drawingBufferHeight());
    return result;
}
