...
public:
    ...
    {
        JSSVGPathSegLinetoVerticalRelConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegLinetoVerticalRelConstructor>(*exec->heap())) JSSVGPathSegLinetoVerticalRelConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegLinetoVerticalRelPrototype::s_info = { "SVGPathSegLinetoVerticalRelPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegLinetoVerticalRelPrototypeTable, 0 };
