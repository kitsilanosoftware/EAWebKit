...
public:
    ...
    {
        JSHTMLBaseElement* ptr = new (JSC::allocateCell<JSHTMLBaseElement>(globalObject->globalData().heap)) JSHTMLBaseElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLBaseElementPrototype* ptr = new (JSC::allocateCell<JSHTMLBaseElementPrototype>(globalData.heap)) JSHTMLBaseElementPrototype(globalData, globalObject, structure);
