...
public:
    ...
    {
        JSSVGFEDisplacementMapElementConstructor* ptr = new (JSC::allocateCell<JSSVGFEDisplacementMapElementConstructor>(*exec->heap())) JSSVGFEDisplacementMapElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFEDisplacementMapElementPrototype::s_info = { "SVGFEDisplacementMapElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFEDisplacementMapElementPrototypeTable, 0 };
