...
public:
    ...
    {
        JSSVGPointListConstructor* ptr = new (JSC::allocateCell<JSSVGPointListConstructor>(*exec->heap())) JSSVGPointListConstructor(structure, globalObject);
...
const ClassInfo JSSVGPointListPrototype::s_info = { "SVGPointListPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPointListPrototypeTable, 0 };
