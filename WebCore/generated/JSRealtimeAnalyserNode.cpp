...
static const HashTableValue JSRealtimeAnalyserNodeTableValues[] =
{
...
static const HashTableValue JSRealtimeAnalyserNodeConstructorTableValues[] =
{
    { 0, 0, 0, 0 THUNK_GENERATOR(0) }
};
...
public:
    ...
    {
        JSRealtimeAnalyserNodeConstructor* ptr = new (JSC::allocateCell<JSRealtimeAnalyserNodeConstructor>(*exec->heap())) JSRealtimeAnalyserNodeConstructor(structure, globalObject);
...
JSRealtimeAnalyserNodeConstructor::JSRealtimeAnalyserNodeConstructor(Structure* structure, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(structure, globalObject)
{
}

void JSRealtimeAnalyserNodeConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
...
static const HashTableValue JSRealtimeAnalyserNodePrototypeTableValues[] =
{
...
const ClassInfo JSRealtimeAnalyserNodePrototype::s_info = { "RealtimeAnalyserNodePrototype", &JSC::JSNonFinalObject::s_info, &JSRealtimeAnalyserNodePrototypeTable, 0 };
...
void JSRealtimeAnalyserNode::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSRealtimeAnalyserNodePrototype::create(exec->globalData(), globalObject, JSRealtimeAnalyserNodePrototype::createStructure(exec->globalData(), globalObject, JSAudioNodePrototype::self(exec, globalObject)));
}
