...
public:
    ...
    {
        JSSQLException* ptr = new (JSC::allocateCell<JSSQLException>(globalObject->globalData().heap)) JSSQLException(structure, globalObject, impl);
...
public:
    ...
    {
        JSSQLExceptionPrototype* ptr = new (JSC::allocateCell<JSSQLExceptionPrototype>(globalData.heap)) JSSQLExceptionPrototype(globalData, globalObject, structure);
