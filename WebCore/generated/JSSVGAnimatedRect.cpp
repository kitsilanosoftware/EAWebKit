...
public:
    ...
    {
        JSSVGAnimatedRectConstructor* ptr = new (JSC::allocateCell<JSSVGAnimatedRectConstructor>(*exec->heap())) JSSVGAnimatedRectConstructor(structure, globalObject);
...
const ClassInfo JSSVGAnimatedRectPrototype::s_info = { "SVGAnimatedRectPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGAnimatedRectPrototypeTable, 0 };
