...
public:
    ...
    {
        JSSVGZoomEventConstructor* ptr = new (JSC::allocateCell<JSSVGZoomEventConstructor>(*exec->heap())) JSSVGZoomEventConstructor(structure, globalObject);
...
const ClassInfo JSSVGZoomEventPrototype::s_info = { "SVGZoomEventPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGZoomEventPrototypeTable, 0 };
