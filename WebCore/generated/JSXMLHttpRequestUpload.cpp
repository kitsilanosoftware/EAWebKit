...
public:
    ...
    {
        JSXMLHttpRequestUploadConstructor* ptr = new (JSC::allocateCell<JSXMLHttpRequestUploadConstructor>(*exec->heap())) JSXMLHttpRequestUploadConstructor(structure, globalObject);
...
const ClassInfo JSXMLHttpRequestUploadPrototype::s_info = { "XMLHttpRequestUploadPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSXMLHttpRequestUploadPrototypeTable };
