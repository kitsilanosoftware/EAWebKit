...
public:
    ...
    {
        JSDOMMimeTypeArrayConstructor* ptr = new (JSC::allocateCell<JSDOMMimeTypeArrayConstructor>(*exec->heap())) JSDOMMimeTypeArrayConstructor(structure, globalObject);
...
const ClassInfo JSDOMMimeTypeArrayPrototype::s_info = { "MimeTypeArrayPrototype", &JSC::JSNonFinalObject::s_info, &JSDOMMimeTypeArrayPrototypeTable, 0 };
