...
public:
    ...
    {
        JSLocation* ptr = new (JSC::allocateCell<JSLocation>(globalObject->globalData().heap)) JSLocation(structure, globalObject, impl);
...
public:
    ...
    {
        JSLocationPrototype* ptr = new (JSC::allocateCell<JSLocationPrototype>(globalData.heap)) JSLocationPrototype(globalData, globalObject, structure);
