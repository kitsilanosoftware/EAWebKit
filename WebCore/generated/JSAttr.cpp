...
public:
    ...
    {
        JSAttrConstructor* ptr = new (JSC::allocateCell<JSAttrConstructor>(*exec->heap())) JSAttrConstructor(structure, globalObject);
...
const ClassInfo JSAttrPrototype::s_info = { "AttrPrototype", &JSC::JSNonFinalObject::s_info, &JSAttrPrototypeTable, 0 };
