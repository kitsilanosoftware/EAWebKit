...
public:
    ...
    {
        JSSpeechInputResultListConstructor* ptr = new (JSC::allocateCell<JSSpeechInputResultListConstructor>(*exec->heap())) JSSpeechInputResultListConstructor(structure, globalObject);
...
const ClassInfo JSSpeechInputResultListPrototype::s_info = { "SpeechInputResultListPrototype", &JSC::JSNonFinalObject::s_info, &JSSpeechInputResultListPrototypeTable, 0 };
