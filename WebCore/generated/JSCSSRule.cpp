...
public:
    ...
    {
        JSCSSRuleConstructor* ptr = new (JSC::allocateCell<JSCSSRuleConstructor>(*exec->heap())) JSCSSRuleConstructor(structure, globalObject);
...
const ClassInfo JSCSSRulePrototype::s_info = { "CSSRulePrototype", &JSC::JSNonFinalObject::s_info, &JSCSSRulePrototypeTable, 0 };
