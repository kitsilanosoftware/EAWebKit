...
public:
    ...
    {
        JSDOMParser* ptr = new (JSC::allocateCell<JSDOMParser>(globalObject->globalData().heap)) JSDOMParser(structure, globalObject, impl);
...
public:
    ...
    {
        JSDOMParserPrototype* ptr = new (JSC::allocateCell<JSDOMParserPrototype>(globalData.heap)) JSDOMParserPrototype(globalData, globalObject, structure);
