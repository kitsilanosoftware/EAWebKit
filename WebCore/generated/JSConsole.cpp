...
static const HashTableValue JSConsolePrototypeTableValues[] =
{
    ...
    { "timeStamp", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsConsolePrototypeFunctionTimeStamp), (intptr_t)0 THUNK_GENERATOR(0) },
...
const ClassInfo JSConsolePrototype::s_info = { "ConsolePrototype", &JSC::JSNonFinalObject::s_info, &JSConsolePrototypeTable, 0 };
