...
public:
    ...
    {
        JSXPathExpressionConstructor* ptr = new (JSC::allocateCell<JSXPathExpressionConstructor>(*exec->heap())) JSXPathExpressionConstructor(structure, globalObject);
...
const ClassInfo JSXPathExpressionPrototype::s_info = { "XPathExpressionPrototype", &JSC::JSNonFinalObject::s_info, &JSXPathExpressionPrototypeTable, 0 };
