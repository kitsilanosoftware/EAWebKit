...
public:
    ...
    {
        JSDOMParserConstructor* ptr = new (JSC::allocateCell<JSDOMParserConstructor>(*exec->heap())) JSDOMParserConstructor(structure, globalObject);
...
const ClassInfo JSDOMParserPrototype::s_info = { "DOMParserPrototype", &JSC::JSNonFinalObject::s_info, &JSDOMParserPrototypeTable, 0 };
