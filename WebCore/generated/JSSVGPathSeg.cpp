...
public:
    ...
    {
        JSSVGPathSegConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegConstructor>(*exec->heap())) JSSVGPathSegConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegPrototype::s_info = { "SVGPathSegPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegPrototypeTable, 0 };
