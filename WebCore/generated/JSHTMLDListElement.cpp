...
public:
    ...
    {
        JSHTMLDListElementConstructor* ptr = new (JSC::allocateCell<JSHTMLDListElementConstructor>(*exec->heap())) JSHTMLDListElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLDListElementPrototype::s_info = { "HTMLDListElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLDListElementPrototypeTable, 0 };
