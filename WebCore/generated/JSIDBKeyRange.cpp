...
public:
    ...
    {
        JSIDBKeyRangeConstructor* ptr = new (JSC::allocateCell<JSIDBKeyRangeConstructor>(*exec->heap())) JSIDBKeyRangeConstructor(structure, globalObject);
...
const ClassInfo JSIDBKeyRangePrototype::s_info = { "IDBKeyRangePrototype", &JSC::JSNonFinalObject::s_info, &JSIDBKeyRangePrototypeTable, 0 };
