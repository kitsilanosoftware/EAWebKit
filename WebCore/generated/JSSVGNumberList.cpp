...
public:
    ...
    {
        JSSVGNumberListConstructor* ptr = new (JSC::allocateCell<JSSVGNumberListConstructor>(*exec->heap())) JSSVGNumberListConstructor(structure, globalObject);
...
const ClassInfo JSSVGNumberListPrototype::s_info = { "SVGNumberListPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGNumberListPrototypeTable, 0 };
