...
public:
    ...
    {
        JSTreeWalkerConstructor* ptr = new (JSC::allocateCell<JSTreeWalkerConstructor>(*exec->heap())) JSTreeWalkerConstructor(structure, globalObject);
...
const ClassInfo JSTreeWalkerPrototype::s_info = { "TreeWalkerPrototype", &JSC::JSNonFinalObject::s_info, &JSTreeWalkerPrototypeTable, 0 };
