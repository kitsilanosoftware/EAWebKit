...
public:
    ...
    {
        JSWebKitTransitionEventConstructor* ptr = new (JSC::allocateCell<JSWebKitTransitionEventConstructor>(*exec->heap())) JSWebKitTransitionEventConstructor(structure, globalObject);
...
const ClassInfo JSWebKitTransitionEventPrototype::s_info = { "WebKitTransitionEventPrototype", &JSC::JSNonFinalObject::s_info, &JSWebKitTransitionEventPrototypeTable, 0 };
