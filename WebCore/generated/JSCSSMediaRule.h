...
public:
    ...
    {
        JSCSSMediaRule* ptr = new (JSC::allocateCell<JSCSSMediaRule>(globalObject->globalData().heap)) JSCSSMediaRule(structure, globalObject, impl);
...
public:
    ...
    {
        JSCSSMediaRulePrototype* ptr = new (JSC::allocateCell<JSCSSMediaRulePrototype>(globalData.heap)) JSCSSMediaRulePrototype(globalData, globalObject, structure);
