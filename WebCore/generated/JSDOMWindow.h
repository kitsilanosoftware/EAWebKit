...
public:
    ...
    {
        JSDOMWindow* ptr = new (JSC::allocateCell<JSDOMWindow>(globalData.heap)) JSDOMWindow(globalData, structure, impl, windowShell);
        return ptr;
    }
    ...
    JSC::JSValue float64Array(JSC::ExecState*) const;
...
public:
    ...
    {
        JSDOMWindowPrototype* ptr = new (JSC::allocateCell<JSDOMWindowPrototype>(globalData.heap)) JSDOMWindowPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsDOMWindowPerformance(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
