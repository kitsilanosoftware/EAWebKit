...
public:
    ...
    {
        JSHTMLOptGroupElement* ptr = new (JSC::allocateCell<JSHTMLOptGroupElement>(globalObject->globalData().heap)) JSHTMLOptGroupElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLOptGroupElementPrototype* ptr = new (JSC::allocateCell<JSHTMLOptGroupElementPrototype>(globalData.heap)) JSHTMLOptGroupElementPrototype(globalData, globalObject, structure);
