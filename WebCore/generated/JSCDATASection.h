...
public:
    ...
    {
        JSCDATASection* ptr = new (JSC::allocateCell<JSCDATASection>(globalObject->globalData().heap)) JSCDATASection(structure, globalObject, impl);
...
public:
    ...
    {
        JSCDATASectionPrototype* ptr = new (JSC::allocateCell<JSCDATASectionPrototype>(globalData.heap)) JSCDATASectionPrototype(globalData, globalObject, structure);
