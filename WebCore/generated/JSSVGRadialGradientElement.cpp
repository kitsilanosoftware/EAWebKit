...
public:
    ...
    {
        JSSVGRadialGradientElementConstructor* ptr = new (JSC::allocateCell<JSSVGRadialGradientElementConstructor>(*exec->heap())) JSSVGRadialGradientElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGRadialGradientElementPrototype::s_info = { "SVGRadialGradientElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGRadialGradientElementPrototypeTable, 0 };
