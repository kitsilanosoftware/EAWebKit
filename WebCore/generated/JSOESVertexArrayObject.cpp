...
const ClassInfo JSOESVertexArrayObjectPrototype::s_info = { "OESVertexArrayObjectPrototype", &JSC::JSNonFinalObject::s_info, &JSOESVertexArrayObjectPrototypeTable, 0 };
