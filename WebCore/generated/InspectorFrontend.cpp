...
void InspectorFrontend::Network::requestWillBeSent(const String& requestId, const String& frameId, const String& loaderId, const String& documentURL, PassRefPtr<InspectorObject> request, double timestamp, PassRefPtr<InspectorObject> initiator, PassRefPtr<InspectorArray> stackTrace, PassRefPtr<InspectorObject> redirectResponse)
{
...
void InspectorFrontend::Network::resourceMarkedAsCached(const String& requestId)
{
...
void InspectorFrontend::Network::responseReceived(const String& requestId, double timestamp, const String& type, PassRefPtr<InspectorObject> response)
{
...
void InspectorFrontend::Network::loadingFailed(const String& requestId, double timestamp, const String& errorText, bool canceled)
{
...
void InspectorFrontend::Network::resourceLoadedFromMemoryCache(const String& requestId, const String& frameId, const String& loaderId, const String& documentURL, double timestamp, PassRefPtr<InspectorObject> initiator, PassRefPtr<InspectorObject> resource)
{
...
void InspectorFrontend::Network::webSocketWillSendHandshakeRequest(const String& requestId, double timestamp, PassRefPtr<InspectorObject> request)
{
...
void InspectorFrontend::Network::webSocketHandshakeResponseReceived(const String& requestId, double timestamp, PassRefPtr<InspectorObject> response)
{
...
void InspectorFrontend::DOM::attributesUpdated(int nodeId)
{
...
void InspectorFrontend::DOM::characterDataModified(int nodeId, const String& newValue)
{
...
void InspectorFrontend::DOM::childNodeCountUpdated(int nodeId, int newValue)
{
...
void InspectorFrontend::DOM::childNodeInserted(int parentNodeId, int previousNodeId, PassRefPtr<InspectorObject> node)
{
...
void InspectorFrontend::Debugger::scriptParsed(const String& scriptId, const String& url, int startLine, int startColumn, int endLine, int endColumn, bool isContentScript)
{
