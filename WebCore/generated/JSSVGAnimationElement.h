...
public:
    ...
    {
        JSSVGAnimationElement* ptr = new (JSC::allocateCell<JSSVGAnimationElement>(globalObject->globalData().heap)) JSSVGAnimationElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnimationElementPrototype* ptr = new (JSC::allocateCell<JSSVGAnimationElementPrototype>(globalData.heap)) JSSVGAnimationElementPrototype(globalData, globalObject, structure);
