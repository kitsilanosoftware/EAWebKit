...
static const HashTableValue JSJavaScriptAudioNodeTableValues[] =
{
...
static const HashTableValue JSJavaScriptAudioNodeConstructorTableValues[] =
{
    { 0, 0, 0, 0 THUNK_GENERATOR(0) }
};
...
public:
    ...
    {
        JSJavaScriptAudioNodeConstructor* ptr = new (JSC::allocateCell<JSJavaScriptAudioNodeConstructor>(*exec->heap())) JSJavaScriptAudioNodeConstructor(structure, globalObject);
...
JSJavaScriptAudioNodeConstructor::JSJavaScriptAudioNodeConstructor(Structure* structure, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(structure, globalObject)
{
}

void JSJavaScriptAudioNodeConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
...
static const HashTableValue JSJavaScriptAudioNodePrototypeTableValues[] =
{
    { 0, 0, 0, 0 THUNK_GENERATOR(0) }
};
...
const ClassInfo JSJavaScriptAudioNodePrototype::s_info = { "JavaScriptAudioNodePrototype", &JSC::JSNonFinalObject::s_info, &JSJavaScriptAudioNodePrototypeTable, 0 };
...
void JSJavaScriptAudioNode::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSJavaScriptAudioNodePrototype::create(exec->globalData(), globalObject, JSJavaScriptAudioNodePrototype::createStructure(exec->globalData(), globalObject, JSAudioNodePrototype::self(exec, globalObject)));
}
