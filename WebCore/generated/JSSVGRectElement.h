...
public:
    ...
    {
        JSSVGRectElement* ptr = new (JSC::allocateCell<JSSVGRectElement>(globalObject->globalData().heap)) JSSVGRectElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGRectElementPrototype* ptr = new (JSC::allocateCell<JSSVGRectElementPrototype>(globalData.heap)) JSSVGRectElementPrototype(globalData, globalObject, structure);
