...
public:
    ...
    {
        JSClientRectListConstructor* ptr = new (JSC::allocateCell<JSClientRectListConstructor>(*exec->heap())) JSClientRectListConstructor(structure, globalObject);
...
const ClassInfo JSClientRectListPrototype::s_info = { "ClientRectListPrototype", &JSC::JSNonFinalObject::s_info, &JSClientRectListPrototypeTable, 0 };
