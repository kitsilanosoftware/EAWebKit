...
public:
    ...
    {
        JSRangeExceptionConstructor* ptr = new (JSC::allocateCell<JSRangeExceptionConstructor>(*exec->heap())) JSRangeExceptionConstructor(structure, globalObject);
...
const ClassInfo JSRangeExceptionPrototype::s_info = { "RangeExceptionPrototype", &JSC::JSNonFinalObject::s_info, &JSRangeExceptionPrototypeTable, 0 };
...
{
    return JSRangeExceptionPrototype::create(exec->globalData(), globalObject, JSRangeExceptionPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
