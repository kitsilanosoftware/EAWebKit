...
public:
    ...
    {
        JSHTMLUListElementConstructor* ptr = new (JSC::allocateCell<JSHTMLUListElementConstructor>(*exec->heap())) JSHTMLUListElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLUListElementPrototype::s_info = { "HTMLUListElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLUListElementPrototypeTable, 0 };
