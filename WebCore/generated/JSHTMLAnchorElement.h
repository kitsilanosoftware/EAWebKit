...
public:
    ...
    {
        JSHTMLAnchorElement* ptr = new (JSC::allocateCell<JSHTMLAnchorElement>(globalObject->globalData().heap)) JSHTMLAnchorElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLAnchorElementPrototype* ptr = new (JSC::allocateCell<JSHTMLAnchorElementPrototype>(globalData.heap)) JSHTMLAnchorElementPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsHTMLAnchorElementDownload(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
