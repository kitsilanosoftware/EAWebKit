...
public:
    ...
    {
        JSXPathExceptionConstructor* ptr = new (JSC::allocateCell<JSXPathExceptionConstructor>(*exec->heap())) JSXPathExceptionConstructor(structure, globalObject);
...
const ClassInfo JSXPathExceptionPrototype::s_info = { "XPathExceptionPrototype", &JSC::JSNonFinalObject::s_info, &JSXPathExceptionPrototypeTable, 0 };
