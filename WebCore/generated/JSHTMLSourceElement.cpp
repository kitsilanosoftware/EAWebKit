...
public:
    ...
    {
        JSHTMLSourceElementConstructor* ptr = new (JSC::allocateCell<JSHTMLSourceElementConstructor>(*exec->heap())) JSHTMLSourceElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLSourceElementPrototype::s_info = { "HTMLSourceElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLSourceElementPrototypeTable, 0 };
