...
public:
    ...
    {
        JSDocument* ptr = new (JSC::allocateCell<JSDocument>(globalObject->globalData().heap)) JSDocument(structure, globalObject, impl);
...
public:
    ...
    {
        JSDocumentPrototype* ptr = new (JSC::allocateCell<JSDocumentPrototype>(globalData.heap)) JSDocumentPrototype(globalData, globalObject, structure);
