...
public:
    ...
    {
        JSSVGPathSegListConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegListConstructor>(*exec->heap())) JSSVGPathSegListConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegListPrototype::s_info = { "SVGPathSegListPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegListPrototypeTable, 0 };
