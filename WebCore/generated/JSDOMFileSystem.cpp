...
public:
    ...
    {
        JSDOMFileSystemConstructor* ptr = new (JSC::allocateCell<JSDOMFileSystemConstructor>(*exec->heap())) JSDOMFileSystemConstructor(structure, globalObject);
...
const ClassInfo JSDOMFileSystemPrototype::s_info = { "DOMFileSystemPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSDOMFileSystemPrototypeTable };
