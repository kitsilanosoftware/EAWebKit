...
public:
    ...
    {
        JSDocumentType* ptr = new (JSC::allocateCell<JSDocumentType>(globalObject->globalData().heap)) JSDocumentType(structure, globalObject, impl);
...
public:
    ...
    {
        JSDocumentTypePrototype* ptr = new (JSC::allocateCell<JSDocumentTypePrototype>(globalData.heap)) JSDocumentTypePrototype(globalData, globalObject, structure);
