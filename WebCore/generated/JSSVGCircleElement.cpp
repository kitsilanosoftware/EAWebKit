...
public:
    ...
    {
        JSSVGCircleElementConstructor* ptr = new (JSC::allocateCell<JSSVGCircleElementConstructor>(*exec->heap())) JSSVGCircleElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGCircleElementPrototype::s_info = { "SVGCircleElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGCircleElementPrototypeTable, 0 };
