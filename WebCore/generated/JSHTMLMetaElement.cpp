...
public:
    ...
    {
        JSHTMLMetaElementConstructor* ptr = new (JSC::allocateCell<JSHTMLMetaElementConstructor>(*exec->heap())) JSHTMLMetaElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLMetaElementPrototype::s_info = { "HTMLMetaElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLMetaElementPrototypeTable, 0 };
