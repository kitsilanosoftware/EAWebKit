...
public:
    ...
    {
        JSInt16Array* ptr = new (JSC::allocateCell<JSInt16Array>(globalObject->globalData().heap)) JSInt16Array(structure, globalObject, impl);
...
public:
    ...
    {
        JSInt16ArrayPrototype* ptr = new (JSC::allocateCell<JSInt16ArrayPrototype>(globalData.heap)) JSInt16ArrayPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSInt16ArrayConstructor* ptr = new (JSC::allocateCell<JSInt16ArrayConstructor>(*exec->heap())) JSInt16ArrayConstructor(structure, globalObject);
