...
public:
    ...
    {
        JSTextMetricsConstructor* ptr = new (JSC::allocateCell<JSTextMetricsConstructor>(*exec->heap())) JSTextMetricsConstructor(structure, globalObject);
...
const ClassInfo JSTextMetricsPrototype::s_info = { "TextMetricsPrototype", &JSC::JSNonFinalObject::s_info, &JSTextMetricsPrototypeTable, 0 };
