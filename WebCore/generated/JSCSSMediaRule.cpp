...
public:
    ...
    {
        JSCSSMediaRuleConstructor* ptr = new (JSC::allocateCell<JSCSSMediaRuleConstructor>(*exec->heap())) JSCSSMediaRuleConstructor(structure, globalObject);
...
const ClassInfo JSCSSMediaRulePrototype::s_info = { "CSSMediaRulePrototype", &JSC::JSNonFinalObject::s_info, &JSCSSMediaRulePrototypeTable, 0 };
