...
public:
    ...
    {
        JSMessagePort* ptr = new (JSC::allocateCell<JSMessagePort>(globalObject->globalData().heap)) JSMessagePort(structure, globalObject, impl);
...
public:
    ...
    {
        JSMessagePortPrototype* ptr = new (JSC::allocateCell<JSMessagePortPrototype>(globalData.heap)) JSMessagePortPrototype(globalData, globalObject, structure);
