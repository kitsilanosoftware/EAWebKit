...
const ClassInfo JSSQLTransactionPrototype::s_info = { "SQLTransactionPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSSQLTransactionPrototypeTable };
...
void JSSQLTransaction::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSQLTransactionPrototype::create(exec->globalData(), globalObject, JSSQLTransactionPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
