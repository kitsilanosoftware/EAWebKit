...
public:
    ...
    {
        JSDOMImplementationConstructor* ptr = new (JSC::allocateCell<JSDOMImplementationConstructor>(*exec->heap())) JSDOMImplementationConstructor(structure, globalObject);
...
const ClassInfo JSDOMImplementationPrototype::s_info = { "DOMImplementationPrototype", &JSC::JSNonFinalObject::s_info, &JSDOMImplementationPrototypeTable, 0 };
