...
public:
    ...
    {
        JSSVGAnimatedEnumeration* ptr = new (JSC::allocateCell<JSSVGAnimatedEnumeration>(globalObject->globalData().heap)) JSSVGAnimatedEnumeration(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnimatedEnumerationPrototype* ptr = new (JSC::allocateCell<JSSVGAnimatedEnumerationPrototype>(globalData.heap)) JSSVGAnimatedEnumerationPrototype(globalData, globalObject, structure);
