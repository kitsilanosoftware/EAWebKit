...
static const HashTableValue JSHTMLImageElementTableValues[] =
{
    ...
    { "crossOrigin", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLImageElementCrossOrigin), (intptr_t)setJSHTMLImageElementCrossOrigin THUNK_GENERATOR(0) },
...
public:
    ...
    {
        JSHTMLImageElementConstructor* ptr = new (JSC::allocateCell<JSHTMLImageElementConstructor>(*exec->heap())) JSHTMLImageElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLImageElementPrototype::s_info = { "HTMLImageElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLImageElementPrototypeTable, 0 };
...
JSValue jsHTMLImageElementCrossOrigin(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLImageElement* castedThis = static_cast<JSHTMLImageElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLImageElement* imp = static_cast<HTMLImageElement*>(castedThis->impl());
    JSValue result = jsString(exec, imp->getAttribute(WebCore::HTMLNames::crossoriginAttr));
    return result;
}
...
void setJSHTMLImageElementCrossOrigin(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLImageElement* castedThis = static_cast<JSHTMLImageElement*>(thisObject);
    HTMLImageElement* imp = static_cast<HTMLImageElement*>(castedThis->impl());
    imp->setAttribute(WebCore::HTMLNames::crossoriginAttr, valueToStringWithNullCheck(exec, value));
}
