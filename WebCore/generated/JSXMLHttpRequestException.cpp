...
public:
    ...
    {
        JSXMLHttpRequestExceptionConstructor* ptr = new (JSC::allocateCell<JSXMLHttpRequestExceptionConstructor>(*exec->heap())) JSXMLHttpRequestExceptionConstructor(structure, globalObject);
...
const ClassInfo JSXMLHttpRequestExceptionPrototype::s_info = { "XMLHttpRequestExceptionPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSXMLHttpRequestExceptionPrototypeTable };
