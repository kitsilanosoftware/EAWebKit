...
public:
    ...
    {
        JSStorageEventConstructor* ptr = new (JSC::allocateCell<JSStorageEventConstructor>(*exec->heap())) JSStorageEventConstructor(structure, globalObject);
...
const ClassInfo JSStorageEventPrototype::s_info = { "StorageEventPrototype", &JSC::JSNonFinalObject::s_info, &JSStorageEventPrototypeTable, 0 };
