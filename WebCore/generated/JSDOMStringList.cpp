...
public:
    ...
    {
        JSDOMStringListConstructor* ptr = new (JSC::allocateCell<JSDOMStringListConstructor>(*exec->heap())) JSDOMStringListConstructor(structure, globalObject);
...
const ClassInfo JSDOMStringListPrototype::s_info = { "DOMStringListPrototype", &JSC::JSNonFinalObject::s_info, &JSDOMStringListPrototypeTable, 0 };
