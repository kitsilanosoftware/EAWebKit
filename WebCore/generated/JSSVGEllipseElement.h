...
public:
    ...
    {
        JSSVGEllipseElement* ptr = new (JSC::allocateCell<JSSVGEllipseElement>(globalObject->globalData().heap)) JSSVGEllipseElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGEllipseElementPrototype* ptr = new (JSC::allocateCell<JSSVGEllipseElementPrototype>(globalData.heap)) JSSVGEllipseElementPrototype(globalData, globalObject, structure);
