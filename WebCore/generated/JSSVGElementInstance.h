...
public:
    ...
    {
        JSSVGElementInstance* ptr = new (JSC::allocateCell<JSSVGElementInstance>(globalObject->globalData().heap)) JSSVGElementInstance(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGElementInstancePrototype* ptr = new (JSC::allocateCell<JSSVGElementInstancePrototype>(globalData.heap)) JSSVGElementInstancePrototype(globalData, globalObject, structure);
