...
public:
    ...
    {
        JSSVGTSpanElementConstructor* ptr = new (JSC::allocateCell<JSSVGTSpanElementConstructor>(*exec->heap())) JSSVGTSpanElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGTSpanElementPrototype::s_info = { "SVGTSpanElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGTSpanElementPrototypeTable, 0 };
