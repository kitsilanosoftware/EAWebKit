...
public:
    ...
    {
        JSHTMLLegendElementConstructor* ptr = new (JSC::allocateCell<JSHTMLLegendElementConstructor>(*exec->heap())) JSHTMLLegendElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLLegendElementPrototype::s_info = { "HTMLLegendElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLLegendElementPrototypeTable, 0 };
