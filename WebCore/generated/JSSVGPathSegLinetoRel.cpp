...
public:
    ...
    {
        JSSVGPathSegLinetoRelConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegLinetoRelConstructor>(*exec->heap())) JSSVGPathSegLinetoRelConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegLinetoRelPrototype::s_info = { "SVGPathSegLinetoRelPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegLinetoRelPrototypeTable, 0 };
