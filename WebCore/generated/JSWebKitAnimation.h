...
public:
    ...
    {
        JSWebKitAnimation* ptr = new (JSC::allocateCell<JSWebKitAnimation>(globalObject->globalData().heap)) JSWebKitAnimation(structure, globalObject, impl);
...
public:
    ...
    {
        JSWebKitAnimationPrototype* ptr = new (JSC::allocateCell<JSWebKitAnimationPrototype>(globalData.heap)) JSWebKitAnimationPrototype(globalData, globalObject, structure);
