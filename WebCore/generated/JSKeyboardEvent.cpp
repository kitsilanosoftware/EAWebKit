...
public:
    ...
    {
        JSKeyboardEventConstructor* ptr = new (JSC::allocateCell<JSKeyboardEventConstructor>(*exec->heap())) JSKeyboardEventConstructor(structure, globalObject);
...
const ClassInfo JSKeyboardEventPrototype::s_info = { "KeyboardEventPrototype", &JSC::JSNonFinalObject::s_info, &JSKeyboardEventPrototypeTable, 0 };
