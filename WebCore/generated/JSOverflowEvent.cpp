...
public:
    ...
    {
        JSOverflowEventConstructor* ptr = new (JSC::allocateCell<JSOverflowEventConstructor>(*exec->heap())) JSOverflowEventConstructor(structure, globalObject);
...
const ClassInfo JSOverflowEventPrototype::s_info = { "OverflowEventPrototype", &JSC::JSNonFinalObject::s_info, &JSOverflowEventPrototypeTable, 0 };
