...
public:
    ...
    {
        JSSVGAnimateElementConstructor* ptr = new (JSC::allocateCell<JSSVGAnimateElementConstructor>(*exec->heap())) JSSVGAnimateElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGAnimateElementPrototype::s_info = { "SVGAnimateElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGAnimateElementPrototypeTable, 0 };
