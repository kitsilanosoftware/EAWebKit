...
public:
    ...
    {
        JSSVGClipPathElementConstructor* ptr = new (JSC::allocateCell<JSSVGClipPathElementConstructor>(*exec->heap())) JSSVGClipPathElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGClipPathElementPrototype::s_info = { "SVGClipPathElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGClipPathElementPrototypeTable, 0 };
