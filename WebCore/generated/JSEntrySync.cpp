...
public:
    ...
    {
        JSEntrySyncConstructor* ptr = new (JSC::allocateCell<JSEntrySyncConstructor>(*exec->heap())) JSEntrySyncConstructor(structure, globalObject);
...
const ClassInfo JSEntrySyncPrototype::s_info = { "EntrySyncPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSEntrySyncPrototypeTable };
