...
public:
    ...
    {
        JSHTMLAppletElement* ptr = new (JSC::allocateCell<JSHTMLAppletElement>(globalObject->globalData().heap)) JSHTMLAppletElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLAppletElementPrototype* ptr = new (JSC::allocateCell<JSHTMLAppletElementPrototype>(globalData.heap)) JSHTMLAppletElementPrototype(globalData, globalObject, structure);
