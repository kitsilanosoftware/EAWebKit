...
public:
    ...
    {
        JSNodeFilter* ptr = new (JSC::allocateCell<JSNodeFilter>(globalObject->globalData().heap)) JSNodeFilter(structure, globalObject, impl);
...
public:
    ...
    {
        JSNodeFilterPrototype* ptr = new (JSC::allocateCell<JSNodeFilterPrototype>(globalData.heap)) JSNodeFilterPrototype(globalData, globalObject, structure);
