...
static const HashTableValue JSHTMLFormElementTableValues[] =
{
    ...
    { "autocomplete", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLFormElementAutocomplete), (intptr_t)setJSHTMLFormElementAutocomplete THUNK_GENERATOR(0) },
...
public:
    ...
    {
        JSHTMLFormElementConstructor* ptr = new (JSC::allocateCell<JSHTMLFormElementConstructor>(*exec->heap())) JSHTMLFormElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLFormElementPrototype::s_info = { "HTMLFormElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLFormElementPrototypeTable, 0 };
