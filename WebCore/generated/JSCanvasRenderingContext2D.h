...
public:
    ...
    {
        JSCanvasRenderingContext2D* ptr = new (JSC::allocateCell<JSCanvasRenderingContext2D>(globalObject->globalData().heap)) JSCanvasRenderingContext2D(structure, globalObject, impl);
...
public:
    ...
    {
        JSCanvasRenderingContext2DPrototype* ptr = new (JSC::allocateCell<JSCanvasRenderingContext2DPrototype>(globalData.heap)) JSCanvasRenderingContext2DPrototype(globalData, globalObject, structure);
