...
public:
    ...
    {
        JSSVGFEFloodElementConstructor* ptr = new (JSC::allocateCell<JSSVGFEFloodElementConstructor>(*exec->heap())) JSSVGFEFloodElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFEFloodElementPrototype::s_info = { "SVGFEFloodElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFEFloodElementPrototypeTable, 0 };
