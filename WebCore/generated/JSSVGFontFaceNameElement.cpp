...
public:
    ...
    {
        JSSVGFontFaceNameElementConstructor* ptr = new (JSC::allocateCell<JSSVGFontFaceNameElementConstructor>(*exec->heap())) JSSVGFontFaceNameElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFontFaceNameElementPrototype::s_info = { "SVGFontFaceNameElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFontFaceNameElementPrototypeTable, 0 };
