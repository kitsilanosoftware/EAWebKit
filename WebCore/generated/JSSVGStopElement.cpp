...
public:
    ...
    {
        JSSVGStopElementConstructor* ptr = new (JSC::allocateCell<JSSVGStopElementConstructor>(*exec->heap())) JSSVGStopElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGStopElementPrototype::s_info = { "SVGStopElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGStopElementPrototypeTable, 0 };
