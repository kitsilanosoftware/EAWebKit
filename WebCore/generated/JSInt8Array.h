...
public:
    ...
    {
        JSInt8Array* ptr = new (JSC::allocateCell<JSInt8Array>(globalObject->globalData().heap)) JSInt8Array(structure, globalObject, impl);
...
public:
    ...
    {
        JSInt8ArrayPrototype* ptr = new (JSC::allocateCell<JSInt8ArrayPrototype>(globalData.heap)) JSInt8ArrayPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSInt8ArrayConstructor* ptr = new (JSC::allocateCell<JSInt8ArrayConstructor>(*exec->heap())) JSInt8ArrayConstructor(structure, globalObject);
