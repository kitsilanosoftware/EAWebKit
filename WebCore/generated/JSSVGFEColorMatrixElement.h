...
public:
    ...
    {
        JSSVGFEColorMatrixElement* ptr = new (JSC::allocateCell<JSSVGFEColorMatrixElement>(globalObject->globalData().heap)) JSSVGFEColorMatrixElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGFEColorMatrixElementPrototype* ptr = new (JSC::allocateCell<JSSVGFEColorMatrixElementPrototype>(globalData.heap)) JSSVGFEColorMatrixElementPrototype(globalData, globalObject, structure);
