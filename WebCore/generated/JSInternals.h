...
public:
    ...
    {
        JSInternals* ptr = new (JSC::allocateCell<JSInternals>(globalObject->globalData().heap)) JSInternals(structure, globalObject, impl);
...
public:
    ...
    {
        JSInternalsPrototype* ptr = new (JSC::allocateCell<JSInternalsPrototype>(globalData.heap)) JSInternalsPrototype(globalData, globalObject, structure);
...
JSC::EncodedJSValue JSC_HOST_CALL jsInternalsPrototypeFunctionCreateShadowContentElement(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsInternalsPrototypeFunctionGetElementByIdInShadowRoot(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsInternalsPrototypeFunctionDisableMemoryCache(JSC::ExecState*);
...
JSC::EncodedJSValue JSC_HOST_CALL jsInternalsPrototypeFunctionSetForceCompositingMode(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsInternalsPrototypeFunctionSetZoomAnimatorScale(JSC::ExecState*);
