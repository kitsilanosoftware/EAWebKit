...
public:
    ...
    {
        JSSVGUseElementConstructor* ptr = new (JSC::allocateCell<JSSVGUseElementConstructor>(*exec->heap())) JSSVGUseElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGUseElementPrototype::s_info = { "SVGUseElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGUseElementPrototypeTable, 0 };
