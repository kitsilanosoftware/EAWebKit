...
public:
    ...
    {
        JSCSSCharsetRule* ptr = new (JSC::allocateCell<JSCSSCharsetRule>(globalObject->globalData().heap)) JSCSSCharsetRule(structure, globalObject, impl);
...
public:
    ...
    {
        JSCSSCharsetRulePrototype* ptr = new (JSC::allocateCell<JSCSSCharsetRulePrototype>(globalData.heap)) JSCSSCharsetRulePrototype(globalData, globalObject, structure);
