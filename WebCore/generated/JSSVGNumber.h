...
public:
    ...
    {
        JSSVGNumber* ptr = new (JSC::allocateCell<JSSVGNumber>(globalObject->globalData().heap)) JSSVGNumber(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGNumberPrototype* ptr = new (JSC::allocateCell<JSSVGNumberPrototype>(globalData.heap)) JSSVGNumberPrototype(globalData, globalObject, structure);
