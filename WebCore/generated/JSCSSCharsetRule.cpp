...
public:
    ...
    {
        JSCSSCharsetRuleConstructor* ptr = new (JSC::allocateCell<JSCSSCharsetRuleConstructor>(*exec->heap())) JSCSSCharsetRuleConstructor(structure, globalObject);
...
const ClassInfo JSCSSCharsetRulePrototype::s_info = { "CSSCharsetRulePrototype", &JSC::JSNonFinalObject::s_info, &JSCSSCharsetRulePrototypeTable, 0 };
