...
public:
    ...
    {
        JSMediaErrorConstructor* ptr = new (JSC::allocateCell<JSMediaErrorConstructor>(*exec->heap())) JSMediaErrorConstructor(structure, globalObject);
...
const ClassInfo JSMediaErrorPrototype::s_info = { "MediaErrorPrototype", &JSC::JSNonFinalObject::s_info, &JSMediaErrorPrototypeTable, 0 };
