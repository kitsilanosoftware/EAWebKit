...
public:
    ...
    {
        JSHTMLFontElementConstructor* ptr = new (JSC::allocateCell<JSHTMLFontElementConstructor>(*exec->heap())) JSHTMLFontElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLFontElementPrototype::s_info = { "HTMLFontElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLFontElementPrototypeTable, 0 };
