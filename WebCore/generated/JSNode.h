...
public:
    ...
    {
        JSNode* ptr = new (JSC::allocateCell<JSNode>(globalObject->globalData().heap)) JSNode(structure, globalObject, impl);
...
public:
    ...
    {
        JSNodePrototype* ptr = new (JSC::allocateCell<JSNodePrototype>(globalData.heap)) JSNodePrototype(globalData, globalObject, structure);
