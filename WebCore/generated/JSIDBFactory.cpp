...
public:
    ...
    {
        JSIDBFactoryConstructor* ptr = new (JSC::allocateCell<JSIDBFactoryConstructor>(*exec->heap())) JSIDBFactoryConstructor(structure, globalObject);
...
const ClassInfo JSIDBFactoryPrototype::s_info = { "IDBFactoryPrototype", &JSC::JSNonFinalObject::s_info, &JSIDBFactoryPrototypeTable, 0 };
