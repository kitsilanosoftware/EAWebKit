...
public:
    ...
    {
        JSSVGAnimatedRect* ptr = new (JSC::allocateCell<JSSVGAnimatedRect>(globalObject->globalData().heap)) JSSVGAnimatedRect(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnimatedRectPrototype* ptr = new (JSC::allocateCell<JSSVGAnimatedRectPrototype>(globalData.heap)) JSSVGAnimatedRectPrototype(globalData, globalObject, structure);
