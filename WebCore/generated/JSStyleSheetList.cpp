...
public:
    ...
    {
        JSStyleSheetListConstructor* ptr = new (JSC::allocateCell<JSStyleSheetListConstructor>(*exec->heap())) JSStyleSheetListConstructor(structure, globalObject);
...
const ClassInfo JSStyleSheetListPrototype::s_info = { "StyleSheetListPrototype", &JSC::JSNonFinalObject::s_info, &JSStyleSheetListPrototypeTable, 0 };
