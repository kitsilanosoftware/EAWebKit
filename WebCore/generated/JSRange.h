...
public:
    ...
    {
        JSRange* ptr = new (JSC::allocateCell<JSRange>(globalObject->globalData().heap)) JSRange(structure, globalObject, impl);
...
public:
    ...
    {
        JSRangePrototype* ptr = new (JSC::allocateCell<JSRangePrototype>(globalData.heap)) JSRangePrototype(globalData, globalObject, structure);
