...
public:
    ...
    {
        JSCDATASectionConstructor* ptr = new (JSC::allocateCell<JSCDATASectionConstructor>(*exec->heap())) JSCDATASectionConstructor(structure, globalObject);
...
const ClassInfo JSCDATASectionPrototype::s_info = { "CDATASectionPrototype", &JSC::JSNonFinalObject::s_info, &JSCDATASectionPrototypeTable, 0 };
