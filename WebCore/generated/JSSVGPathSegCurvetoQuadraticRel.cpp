...
public:
    ...
    {
        JSSVGPathSegCurvetoQuadraticRelConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegCurvetoQuadraticRelConstructor>(*exec->heap())) JSSVGPathSegCurvetoQuadraticRelConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegCurvetoQuadraticRelPrototype::s_info = { "SVGPathSegCurvetoQuadraticRelPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegCurvetoQuadraticRelPrototypeTable, 0 };
