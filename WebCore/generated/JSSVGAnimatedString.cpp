...
public:
    ...
    {
        JSSVGAnimatedStringConstructor* ptr = new (JSC::allocateCell<JSSVGAnimatedStringConstructor>(*exec->heap())) JSSVGAnimatedStringConstructor(structure, globalObject);
...
const ClassInfo JSSVGAnimatedStringPrototype::s_info = { "SVGAnimatedStringPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGAnimatedStringPrototypeTable, 0 };
...
void setJSSVGAnimatedStringBaseVal(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    SVGAnimatedString* imp = static_cast<SVGAnimatedString*>(castedThis->impl());
    ExceptionCode ec = 0;
    imp->setBaseVal(ustringToString(value.toString(exec)), ec);
