...
public:
    ...
    {
        JSSVGPathSegCurvetoCubicSmoothAbsConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegCurvetoCubicSmoothAbsConstructor>(*exec->heap())) JSSVGPathSegCurvetoCubicSmoothAbsConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegCurvetoCubicSmoothAbsPrototype::s_info = { "SVGPathSegCurvetoCubicSmoothAbsPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegCurvetoCubicSmoothAbsPrototypeTable, 0 };
