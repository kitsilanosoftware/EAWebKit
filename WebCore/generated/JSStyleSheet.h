...
public:
    ...
    {
        JSStyleSheet* ptr = new (JSC::allocateCell<JSStyleSheet>(globalObject->globalData().heap)) JSStyleSheet(structure, globalObject, impl);
...
public:
    ...
    {
        JSStyleSheetPrototype* ptr = new (JSC::allocateCell<JSStyleSheetPrototype>(globalData.heap)) JSStyleSheetPrototype(globalData, globalObject, structure);
