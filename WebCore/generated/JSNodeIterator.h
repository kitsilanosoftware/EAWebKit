...
public:
    ...
    {
        JSNodeIterator* ptr = new (JSC::allocateCell<JSNodeIterator>(globalObject->globalData().heap)) JSNodeIterator(structure, globalObject, impl);
...
public:
    ...
    {
        JSNodeIteratorPrototype* ptr = new (JSC::allocateCell<JSNodeIteratorPrototype>(globalData.heap)) JSNodeIteratorPrototype(globalData, globalObject, structure);
