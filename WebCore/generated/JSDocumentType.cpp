...
public:
    ...
    {
        JSDocumentTypeConstructor* ptr = new (JSC::allocateCell<JSDocumentTypeConstructor>(*exec->heap())) JSDocumentTypeConstructor(structure, globalObject);
...
const ClassInfo JSDocumentTypePrototype::s_info = { "DocumentTypePrototype", &JSC::JSNonFinalObject::s_info, &JSDocumentTypePrototypeTable, 0 };
