...
public:
    ...
    {
        JSStyleMediaConstructor* ptr = new (JSC::allocateCell<JSStyleMediaConstructor>(*exec->heap())) JSStyleMediaConstructor(structure, globalObject);
...
const ClassInfo JSStyleMediaPrototype::s_info = { "StyleMediaPrototype", &JSC::JSNonFinalObject::s_info, &JSStyleMediaPrototypeTable, 0 };
