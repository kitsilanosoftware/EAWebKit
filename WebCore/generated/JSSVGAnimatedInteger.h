...
public:
    ...
    {
        JSSVGAnimatedInteger* ptr = new (JSC::allocateCell<JSSVGAnimatedInteger>(globalObject->globalData().heap)) JSSVGAnimatedInteger(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnimatedIntegerPrototype* ptr = new (JSC::allocateCell<JSSVGAnimatedIntegerPrototype>(globalData.heap)) JSSVGAnimatedIntegerPrototype(globalData, globalObject, structure);
