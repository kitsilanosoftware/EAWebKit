...
public:
    ...
    {
        JSWebKitCSSMatrix* ptr = new (JSC::allocateCell<JSWebKitCSSMatrix>(globalObject->globalData().heap)) JSWebKitCSSMatrix(structure, globalObject, impl);
...
public:
    ...
    {
        JSWebKitCSSMatrixPrototype* ptr = new (JSC::allocateCell<JSWebKitCSSMatrixPrototype>(globalData.heap)) JSWebKitCSSMatrixPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSWebKitCSSMatrixConstructor* ptr = new (JSC::allocateCell<JSWebKitCSSMatrixConstructor>(*exec->heap())) JSWebKitCSSMatrixConstructor(structure, globalObject);
