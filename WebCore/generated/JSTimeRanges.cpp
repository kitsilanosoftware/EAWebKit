...
public:
    ...
    {
        JSTimeRangesConstructor* ptr = new (JSC::allocateCell<JSTimeRangesConstructor>(*exec->heap())) JSTimeRangesConstructor(structure, globalObject);
...
const ClassInfo JSTimeRangesPrototype::s_info = { "TimeRangesPrototype", &JSC::JSNonFinalObject::s_info, &JSTimeRangesPrototypeTable, 0 };
