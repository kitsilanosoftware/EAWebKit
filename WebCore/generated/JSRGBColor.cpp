...
public:
    ...
    {
        JSRGBColorConstructor* ptr = new (JSC::allocateCell<JSRGBColorConstructor>(*exec->heap())) JSRGBColorConstructor(structure, globalObject);
...
const ClassInfo JSRGBColorPrototype::s_info = { "RGBColorPrototype", &JSC::JSNonFinalObject::s_info, &JSRGBColorPrototypeTable, 0 };
