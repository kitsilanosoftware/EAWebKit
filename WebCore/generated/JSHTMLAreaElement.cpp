...
public:
    ...
    {
        JSHTMLAreaElementConstructor* ptr = new (JSC::allocateCell<JSHTMLAreaElementConstructor>(*exec->heap())) JSHTMLAreaElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLAreaElementPrototype::s_info = { "HTMLAreaElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLAreaElementPrototypeTable, 0 };
