...
public:
    ...
    {
        JSHTMLMapElementConstructor* ptr = new (JSC::allocateCell<JSHTMLMapElementConstructor>(*exec->heap())) JSHTMLMapElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLMapElementPrototype::s_info = { "HTMLMapElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLMapElementPrototypeTable, 0 };
