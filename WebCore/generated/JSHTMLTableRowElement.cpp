...
public:
    ...
    {
        JSHTMLTableRowElementConstructor* ptr = new (JSC::allocateCell<JSHTMLTableRowElementConstructor>(*exec->heap())) JSHTMLTableRowElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLTableRowElementPrototype::s_info = { "HTMLTableRowElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLTableRowElementPrototypeTable, 0 };
