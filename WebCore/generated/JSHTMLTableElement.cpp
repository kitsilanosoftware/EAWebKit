...
public:
    ...
    {
        JSHTMLTableElementConstructor* ptr = new (JSC::allocateCell<JSHTMLTableElementConstructor>(*exec->heap())) JSHTMLTableElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLTableElementPrototype::s_info = { "HTMLTableElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLTableElementPrototypeTable, 0 };
