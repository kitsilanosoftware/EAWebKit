...
public:
    ...
    {
        JSHTMLAppletElementConstructor* ptr = new (JSC::allocateCell<JSHTMLAppletElementConstructor>(*exec->heap())) JSHTMLAppletElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLAppletElementPrototype::s_info = { "HTMLAppletElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLAppletElementPrototypeTable, 0 };
