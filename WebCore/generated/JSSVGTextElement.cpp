...
public:
    ...
    {
        JSSVGTextElementConstructor* ptr = new (JSC::allocateCell<JSSVGTextElementConstructor>(*exec->heap())) JSSVGTextElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGTextElementPrototype::s_info = { "SVGTextElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGTextElementPrototypeTable, 0 };
