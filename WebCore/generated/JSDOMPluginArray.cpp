...
public:
    ...
    {
        JSDOMPluginArrayConstructor* ptr = new (JSC::allocateCell<JSDOMPluginArrayConstructor>(*exec->heap())) JSDOMPluginArrayConstructor(structure, globalObject);
...
const ClassInfo JSDOMPluginArrayPrototype::s_info = { "PluginArrayPrototype", &JSC::JSNonFinalObject::s_info, &JSDOMPluginArrayPrototypeTable, 0 };
