...
public:
    ...
    {
        JSSVGTransformConstructor* ptr = new (JSC::allocateCell<JSSVGTransformConstructor>(*exec->heap())) JSSVGTransformConstructor(structure, globalObject);
...
const ClassInfo JSSVGTransformPrototype::s_info = { "SVGTransformPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGTransformPrototypeTable, 0 };
