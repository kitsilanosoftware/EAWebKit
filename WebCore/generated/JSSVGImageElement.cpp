...
public:
    ...
    {
        JSSVGImageElementConstructor* ptr = new (JSC::allocateCell<JSSVGImageElementConstructor>(*exec->heap())) JSSVGImageElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGImageElementPrototype::s_info = { "SVGImageElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGImageElementPrototypeTable, 0 };
