...
public:
    ...
    {
        JSHTMLAllCollectionConstructor* ptr = new (JSC::allocateCell<JSHTMLAllCollectionConstructor>(*exec->heap())) JSHTMLAllCollectionConstructor(structure, globalObject);
...
const ClassInfo JSHTMLAllCollectionPrototype::s_info = { "HTMLAllCollectionPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLAllCollectionPrototypeTable, 0 };
