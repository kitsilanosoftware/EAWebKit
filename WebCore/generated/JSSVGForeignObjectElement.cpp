...
public:
    ...
    {
        JSSVGForeignObjectElementConstructor* ptr = new (JSC::allocateCell<JSSVGForeignObjectElementConstructor>(*exec->heap())) JSSVGForeignObjectElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGForeignObjectElementPrototype::s_info = { "SVGForeignObjectElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGForeignObjectElementPrototypeTable, 0 };
