...
public:
    ...
    {
        JSSVGSVGElementConstructor* ptr = new (JSC::allocateCell<JSSVGSVGElementConstructor>(*exec->heap())) JSSVGSVGElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGSVGElementPrototype::s_info = { "SVGSVGElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGSVGElementPrototypeTable, 0 };
