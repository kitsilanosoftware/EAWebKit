...
public:
    ...
    {
        JSUint32Array* ptr = new (JSC::allocateCell<JSUint32Array>(globalObject->globalData().heap)) JSUint32Array(structure, globalObject, impl);
...
public:
    ...
    {
        JSUint32ArrayPrototype* ptr = new (JSC::allocateCell<JSUint32ArrayPrototype>(globalData.heap)) JSUint32ArrayPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSUint32ArrayConstructor* ptr = new (JSC::allocateCell<JSUint32ArrayConstructor>(*exec->heap())) JSUint32ArrayConstructor(structure, globalObject);
