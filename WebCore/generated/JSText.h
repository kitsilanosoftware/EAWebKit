...
public:
    ...
    {
        JSText* ptr = new (JSC::allocateCell<JSText>(globalObject->globalData().heap)) JSText(structure, globalObject, impl);
...
public:
    ...
    {
        JSTextPrototype* ptr = new (JSC::allocateCell<JSTextPrototype>(globalData.heap)) JSTextPrototype(globalData, globalObject, structure);
