...
public:
    ...
    {
        JSSVGPreserveAspectRatioConstructor* ptr = new (JSC::allocateCell<JSSVGPreserveAspectRatioConstructor>(*exec->heap())) JSSVGPreserveAspectRatioConstructor(structure, globalObject);
...
const ClassInfo JSSVGPreserveAspectRatioPrototype::s_info = { "SVGPreserveAspectRatioPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPreserveAspectRatioPrototypeTable, 0 };
