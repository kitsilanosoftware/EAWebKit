...
public:
    ...
    {
        JSNodeListConstructor* ptr = new (JSC::allocateCell<JSNodeListConstructor>(*exec->heap())) JSNodeListConstructor(structure, globalObject);
...
const ClassInfo JSNodeListPrototype::s_info = { "NodeListPrototype", &JSC::JSNonFinalObject::s_info, &JSNodeListPrototypeTable, 0 };
