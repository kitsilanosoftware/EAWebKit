...
public:
    ...
    {
        JSSVGAElementConstructor* ptr = new (JSC::allocateCell<JSSVGAElementConstructor>(*exec->heap())) JSSVGAElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGAElementPrototype::s_info = { "SVGAElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGAElementPrototypeTable, 0 };
