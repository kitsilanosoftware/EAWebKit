...
public:
    ...
    {
        JSSVGPatternElementConstructor* ptr = new (JSC::allocateCell<JSSVGPatternElementConstructor>(*exec->heap())) JSSVGPatternElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGPatternElementPrototype::s_info = { "SVGPatternElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPatternElementPrototypeTable, 0 };
