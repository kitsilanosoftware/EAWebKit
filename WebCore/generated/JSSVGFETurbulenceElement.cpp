...
public:
    ...
    {
        JSSVGFETurbulenceElementConstructor* ptr = new (JSC::allocateCell<JSSVGFETurbulenceElementConstructor>(*exec->heap())) JSSVGFETurbulenceElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFETurbulenceElementPrototype::s_info = { "SVGFETurbulenceElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFETurbulenceElementPrototypeTable, 0 };
