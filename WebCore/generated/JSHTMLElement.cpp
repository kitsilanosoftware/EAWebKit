...
static const HashTableValue JSHTMLElementTableValues[] =
{
    ...
    { "webkitdropzone", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLElementWebkitdropzone), (intptr_t)setJSHTMLElementWebkitdropzone THUNK_GENERATOR(0) },
...
public:
    ...
    {
        JSHTMLElementConstructor* ptr = new (JSC::allocateCell<JSHTMLElementConstructor>(*exec->heap())) JSHTMLElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLElementPrototype::s_info = { "HTMLElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLElementPrototypeTable, 0 };
...
JSValue jsHTMLElementWebkitdropzone(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    HTMLElement* imp = static_cast<HTMLElement*>(castedThis->impl());
    JSValue result = jsString(exec, imp->getAttribute(WebCore::HTMLNames::webkitdropzoneAttr));
    return result;
}
...
void setJSHTMLElementWebkitdropzone(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLElement* castedThis = static_cast<JSHTMLElement*>(thisObject);
    HTMLElement* imp = static_cast<HTMLElement*>(castedThis->impl());
    imp->setAttribute(WebCore::HTMLNames::webkitdropzoneAttr, valueToStringWithNullCheck(exec, value));
}
