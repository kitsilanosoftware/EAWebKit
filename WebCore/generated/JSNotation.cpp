...
public:
    ...
    {
        JSNotationConstructor* ptr = new (JSC::allocateCell<JSNotationConstructor>(*exec->heap())) JSNotationConstructor(structure, globalObject);
...
const ClassInfo JSNotationPrototype::s_info = { "NotationPrototype", &JSC::JSNonFinalObject::s_info, &JSNotationPrototypeTable, 0 };
