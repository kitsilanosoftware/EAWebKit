...
public:
    ...
    {
        JSHTMLDocumentConstructor* ptr = new (JSC::allocateCell<JSHTMLDocumentConstructor>(*exec->heap())) JSHTMLDocumentConstructor(structure, globalObject);
...
const ClassInfo JSHTMLDocumentPrototype::s_info = { "HTMLDocumentPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLDocumentPrototypeTable, 0 };
