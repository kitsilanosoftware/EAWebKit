...
public:
    ...
    {
        JSSVGLinearGradientElement* ptr = new (JSC::allocateCell<JSSVGLinearGradientElement>(globalObject->globalData().heap)) JSSVGLinearGradientElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGLinearGradientElementPrototype* ptr = new (JSC::allocateCell<JSSVGLinearGradientElementPrototype>(globalData.heap)) JSSVGLinearGradientElementPrototype(globalData, globalObject, structure);
