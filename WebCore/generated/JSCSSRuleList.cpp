...
public:
    ...
    {
        JSCSSRuleListConstructor* ptr = new (JSC::allocateCell<JSCSSRuleListConstructor>(*exec->heap())) JSCSSRuleListConstructor(structure, globalObject);
...
const ClassInfo JSCSSRuleListPrototype::s_info = { "CSSRuleListPrototype", &JSC::JSNonFinalObject::s_info, &JSCSSRuleListPrototypeTable, 0 };
