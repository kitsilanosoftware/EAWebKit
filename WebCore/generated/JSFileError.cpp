...
public:
    ...
    {
        JSFileErrorConstructor* ptr = new (JSC::allocateCell<JSFileErrorConstructor>(*exec->heap())) JSFileErrorConstructor(structure, globalObject);
...
const ClassInfo JSFileErrorPrototype::s_info = { "FileErrorPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSFileErrorPrototypeTable };
