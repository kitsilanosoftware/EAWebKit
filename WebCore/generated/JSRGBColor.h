...
public:
    ...
    {
        JSRGBColor* ptr = new (JSC::allocateCell<JSRGBColor>(globalObject->globalData().heap)) JSRGBColor(structure, globalObject, impl);
...
public:
    ...
    {
        JSRGBColorPrototype* ptr = new (JSC::allocateCell<JSRGBColorPrototype>(globalData.heap)) JSRGBColorPrototype(globalData, globalObject, structure);
