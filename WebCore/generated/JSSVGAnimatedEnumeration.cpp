...
public:
    ...
    {
        JSSVGAnimatedEnumerationConstructor* ptr = new (JSC::allocateCell<JSSVGAnimatedEnumerationConstructor>(*exec->heap())) JSSVGAnimatedEnumerationConstructor(structure, globalObject);
...
const ClassInfo JSSVGAnimatedEnumerationPrototype::s_info = { "SVGAnimatedEnumerationPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGAnimatedEnumerationPrototypeTable, 0 };
...
void setJSSVGAnimatedEnumerationBaseVal(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    SVGAnimatedEnumeration* imp = static_cast<SVGAnimatedEnumeration*>(castedThis->impl());
    ExceptionCode ec = 0;
    imp->setBaseVal(value.toUInt32(exec), ec);
