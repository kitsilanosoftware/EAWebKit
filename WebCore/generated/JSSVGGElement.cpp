...
public:
    ...
    {
        JSSVGGElementConstructor* ptr = new (JSC::allocateCell<JSSVGGElementConstructor>(*exec->heap())) JSSVGGElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGGElementPrototype::s_info = { "SVGGElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGGElementPrototypeTable, 0 };
