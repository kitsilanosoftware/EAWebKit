...
public:
    ...
    {
        JSBlob* ptr = new (JSC::allocateCell<JSBlob>(globalObject->globalData().heap)) JSBlob(structure, globalObject, impl);
...
public:
    ...
    {
        JSBlobPrototype* ptr = new (JSC::allocateCell<JSBlobPrototype>(globalData.heap)) JSBlobPrototype(globalData, globalObject, structure);
