...
public:
    ...
    {
        JSSVGPathSegCurvetoQuadraticSmoothRelConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegCurvetoQuadraticSmoothRelConstructor>(*exec->heap())) JSSVGPathSegCurvetoQuadraticSmoothRelConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegCurvetoQuadraticSmoothRelPrototype::s_info = { "SVGPathSegCurvetoQuadraticSmoothRelPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegCurvetoQuadraticSmoothRelPrototypeTable, 0 };
