...
public:
    ...
    {
        JSSVGPathSegMovetoRel* ptr = new (JSC::allocateCell<JSSVGPathSegMovetoRel>(globalObject->globalData().heap)) JSSVGPathSegMovetoRel(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPathSegMovetoRelPrototype* ptr = new (JSC::allocateCell<JSSVGPathSegMovetoRelPrototype>(globalData.heap)) JSSVGPathSegMovetoRelPrototype(globalData, globalObject, structure);
