...
public:
    ...
    {
        JSSVGElementInstanceConstructor* ptr = new (JSC::allocateCell<JSSVGElementInstanceConstructor>(*exec->heap())) JSSVGElementInstanceConstructor(structure, globalObject);
...
const ClassInfo JSSVGElementInstancePrototype::s_info = { "SVGElementInstancePrototype", &JSC::JSNonFinalObject::s_info, &JSSVGElementInstancePrototypeTable, 0 };
...
{
    return JSSVGElementInstancePrototype::create(exec->globalData(), globalObject, JSSVGElementInstancePrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
