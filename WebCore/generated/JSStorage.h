...
public:
    ...
    {
        JSStorage* ptr = new (JSC::allocateCell<JSStorage>(globalObject->globalData().heap)) JSStorage(structure, globalObject, impl);
...
public:
    ...
    {
        JSStoragePrototype* ptr = new (JSC::allocateCell<JSStoragePrototype>(globalData.heap)) JSStoragePrototype(globalData, globalObject, structure);
