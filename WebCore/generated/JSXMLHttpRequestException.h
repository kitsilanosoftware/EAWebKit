...
public:
    ...
    {
        JSXMLHttpRequestException* ptr = new (JSC::allocateCell<JSXMLHttpRequestException>(globalObject->globalData().heap)) JSXMLHttpRequestException(structure, globalObject, impl);
...
public:
    ...
    {
        JSXMLHttpRequestExceptionPrototype* ptr = new (JSC::allocateCell<JSXMLHttpRequestExceptionPrototype>(globalData.heap)) JSXMLHttpRequestExceptionPrototype(globalData, globalObject, structure);
