...
public:
    ...
    {
        JSSVGFEComponentTransferElementConstructor* ptr = new (JSC::allocateCell<JSSVGFEComponentTransferElementConstructor>(*exec->heap())) JSSVGFEComponentTransferElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFEComponentTransferElementPrototype::s_info = { "SVGFEComponentTransferElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFEComponentTransferElementPrototypeTable, 0 };
