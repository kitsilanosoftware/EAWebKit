...
public:
    ...
    {
        JSSVGFEDiffuseLightingElementConstructor* ptr = new (JSC::allocateCell<JSSVGFEDiffuseLightingElementConstructor>(*exec->heap())) JSSVGFEDiffuseLightingElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFEDiffuseLightingElementPrototype::s_info = { "SVGFEDiffuseLightingElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFEDiffuseLightingElementPrototypeTable, 0 };
