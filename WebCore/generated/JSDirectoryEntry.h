...
public:
    ...
    {
        JSDirectoryEntry* ptr = new (JSC::allocateCell<JSDirectoryEntry>(globalObject->globalData().heap)) JSDirectoryEntry(structure, globalObject, impl);
...
public:
    ...
    {
        JSDirectoryEntryPrototype* ptr = new (JSC::allocateCell<JSDirectoryEntryPrototype>(globalData.heap)) JSDirectoryEntryPrototype(globalData, globalObject, structure);
