...
public:
    ...
    {
        JSSVGComponentTransferFunctionElementConstructor* ptr = new (JSC::allocateCell<JSSVGComponentTransferFunctionElementConstructor>(*exec->heap())) JSSVGComponentTransferFunctionElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGComponentTransferFunctionElementPrototype::s_info = { "SVGComponentTransferFunctionElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGComponentTransferFunctionElementPrototypeTable, 0 };
