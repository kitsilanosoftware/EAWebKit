...
public:
    ...
    {
        JSSVGFEFuncAElement* ptr = new (JSC::allocateCell<JSSVGFEFuncAElement>(globalObject->globalData().heap)) JSSVGFEFuncAElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGFEFuncAElementPrototype* ptr = new (JSC::allocateCell<JSSVGFEFuncAElementPrototype>(globalData.heap)) JSSVGFEFuncAElementPrototype(globalData, globalObject, structure);
