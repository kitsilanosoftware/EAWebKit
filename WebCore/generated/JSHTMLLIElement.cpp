...
public:
    ...
    {
        JSHTMLLIElementConstructor* ptr = new (JSC::allocateCell<JSHTMLLIElementConstructor>(*exec->heap())) JSHTMLLIElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLLIElementPrototype::s_info = { "HTMLLIElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLLIElementPrototypeTable, 0 };
