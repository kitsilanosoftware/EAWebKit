...
public:
    ...
    {
        JSSVGLineElementConstructor* ptr = new (JSC::allocateCell<JSSVGLineElementConstructor>(*exec->heap())) JSSVGLineElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGLineElementPrototype::s_info = { "SVGLineElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGLineElementPrototypeTable, 0 };
