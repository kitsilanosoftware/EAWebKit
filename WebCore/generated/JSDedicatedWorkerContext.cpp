...
const ClassInfo JSDedicatedWorkerContextPrototype::s_info = { "DedicatedWorkerContextPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSDedicatedWorkerContextPrototypeTable };
