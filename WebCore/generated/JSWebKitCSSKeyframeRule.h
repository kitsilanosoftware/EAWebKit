...
public:
    ...
    {
        JSWebKitCSSKeyframeRule* ptr = new (JSC::allocateCell<JSWebKitCSSKeyframeRule>(globalObject->globalData().heap)) JSWebKitCSSKeyframeRule(structure, globalObject, impl);
...
public:
    ...
    {
        JSWebKitCSSKeyframeRulePrototype* ptr = new (JSC::allocateCell<JSWebKitCSSKeyframeRulePrototype>(globalData.heap)) JSWebKitCSSKeyframeRulePrototype(globalData, globalObject, structure);
