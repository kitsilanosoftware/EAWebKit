...
public:
    ...
    {
        JSPopStateEventConstructor* ptr = new (JSC::allocateCell<JSPopStateEventConstructor>(*exec->heap())) JSPopStateEventConstructor(structure, globalObject);
...
const ClassInfo JSPopStateEventPrototype::s_info = { "PopStateEventPrototype", &JSC::JSNonFinalObject::s_info, &JSPopStateEventPrototypeTable, 0 };
