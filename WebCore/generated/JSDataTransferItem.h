...
public:
    ...
    {
        JSDataTransferItem* ptr = new (JSC::allocateCell<JSDataTransferItem>(globalObject->globalData().heap)) JSDataTransferItem(structure, globalObject, impl);
...
public:
    ...
    {
        JSDataTransferItemPrototype* ptr = new (JSC::allocateCell<JSDataTransferItemPrototype>(globalData.heap)) JSDataTransferItemPrototype(globalData, globalObject, structure);
