...
public:
    ...
    {
        JSSVGSetElementConstructor* ptr = new (JSC::allocateCell<JSSVGSetElementConstructor>(*exec->heap())) JSSVGSetElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGSetElementPrototype::s_info = { "SVGSetElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGSetElementPrototypeTable, 0 };
