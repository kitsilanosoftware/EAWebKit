...
public:
    ...
    {
        JSIDBIndexConstructor* ptr = new (JSC::allocateCell<JSIDBIndexConstructor>(*exec->heap())) JSIDBIndexConstructor(structure, globalObject);
...
const ClassInfo JSIDBIndexPrototype::s_info = { "IDBIndexPrototype", &JSC::JSNonFinalObject::s_info, &JSIDBIndexPrototypeTable, 0 };
