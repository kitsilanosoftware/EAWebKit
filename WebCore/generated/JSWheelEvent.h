...
public:
    ...
    {
        JSWheelEvent* ptr = new (JSC::allocateCell<JSWheelEvent>(globalObject->globalData().heap)) JSWheelEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSWheelEventPrototype* ptr = new (JSC::allocateCell<JSWheelEventPrototype>(globalData.heap)) JSWheelEventPrototype(globalData, globalObject, structure);
