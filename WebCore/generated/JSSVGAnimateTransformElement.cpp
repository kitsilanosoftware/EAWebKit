...
public:
    ...
    {
        JSSVGAnimateTransformElementConstructor* ptr = new (JSC::allocateCell<JSSVGAnimateTransformElementConstructor>(*exec->heap())) JSSVGAnimateTransformElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGAnimateTransformElementPrototype::s_info = { "SVGAnimateTransformElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGAnimateTransformElementPrototypeTable, 0 };
