...
public:
    ...
    {
        JSSVGMarkerElementConstructor* ptr = new (JSC::allocateCell<JSSVGMarkerElementConstructor>(*exec->heap())) JSSVGMarkerElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGMarkerElementPrototype::s_info = { "SVGMarkerElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGMarkerElementPrototypeTable, 0 };
...
void JSSVGMarkerElement::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSVGMarkerElementPrototype::create(exec->globalData(), globalObject, JSSVGMarkerElementPrototype::createStructure(exec->globalData(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
