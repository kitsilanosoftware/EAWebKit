...
public:
    ...
    {
        JSSVGDescElementConstructor* ptr = new (JSC::allocateCell<JSSVGDescElementConstructor>(*exec->heap())) JSSVGDescElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGDescElementPrototype::s_info = { "SVGDescElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGDescElementPrototypeTable, 0 };
