...
public:
    ...
    {
        JSVoidCallback* ptr = new (JSC::allocateCell<JSVoidCallback>(globalObject->globalData().heap)) JSVoidCallback(structure, globalObject, impl);
...
public:
    ...
    {
        JSVoidCallbackPrototype* ptr = new (JSC::allocateCell<JSVoidCallbackPrototype>(globalData.heap)) JSVoidCallbackPrototype(globalData, globalObject, structure);
