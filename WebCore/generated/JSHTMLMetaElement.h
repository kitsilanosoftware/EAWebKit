...
public:
    ...
    {
        JSHTMLMetaElement* ptr = new (JSC::allocateCell<JSHTMLMetaElement>(globalObject->globalData().heap)) JSHTMLMetaElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLMetaElementPrototype* ptr = new (JSC::allocateCell<JSHTMLMetaElementPrototype>(globalData.heap)) JSHTMLMetaElementPrototype(globalData, globalObject, structure);
