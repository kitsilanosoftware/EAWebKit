...
public:
    ...
    {
        JSHTMLOptionElementConstructor* ptr = new (JSC::allocateCell<JSHTMLOptionElementConstructor>(*exec->heap())) JSHTMLOptionElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLOptionElementPrototype::s_info = { "HTMLOptionElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLOptionElementPrototypeTable, 0 };
