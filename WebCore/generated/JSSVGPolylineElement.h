...
public:
    ...
    {
        JSSVGPolylineElement* ptr = new (JSC::allocateCell<JSSVGPolylineElement>(globalObject->globalData().heap)) JSSVGPolylineElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPolylineElementPrototype* ptr = new (JSC::allocateCell<JSSVGPolylineElementPrototype>(globalData.heap)) JSSVGPolylineElementPrototype(globalData, globalObject, structure);
