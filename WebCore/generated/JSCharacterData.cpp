...
public:
    ...
    {
        JSCharacterDataConstructor* ptr = new (JSC::allocateCell<JSCharacterDataConstructor>(*exec->heap())) JSCharacterDataConstructor(structure, globalObject);
...
const ClassInfo JSCharacterDataPrototype::s_info = { "CharacterDataPrototype", &JSC::JSNonFinalObject::s_info, &JSCharacterDataPrototypeTable, 0 };
