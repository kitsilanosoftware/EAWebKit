...
public:
    ...
    {
        JSFileReaderConstructor* ptr = new (JSC::allocateCell<JSFileReaderConstructor>(*exec->heap())) JSFileReaderConstructor(structure, globalObject);
...
const ClassInfo JSFileReaderPrototype::s_info = { "FileReaderPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSFileReaderPrototypeTable };
