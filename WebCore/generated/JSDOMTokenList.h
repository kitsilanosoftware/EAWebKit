...
public:
    ...
    {
        JSDOMTokenList* ptr = new (JSC::allocateCell<JSDOMTokenList>(globalObject->globalData().heap)) JSDOMTokenList(structure, globalObject, impl);
...
public:
    ...
    {
        JSDOMTokenListPrototype* ptr = new (JSC::allocateCell<JSDOMTokenListPrototype>(globalData.heap)) JSDOMTokenListPrototype(globalData, globalObject, structure);
