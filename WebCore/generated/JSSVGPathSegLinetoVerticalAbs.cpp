...
public:
    ...
    {
        JSSVGPathSegLinetoVerticalAbsConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegLinetoVerticalAbsConstructor>(*exec->heap())) JSSVGPathSegLinetoVerticalAbsConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegLinetoVerticalAbsPrototype::s_info = { "SVGPathSegLinetoVerticalAbsPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegLinetoVerticalAbsPrototypeTable, 0 };
