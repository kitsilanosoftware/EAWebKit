...
public:
    ...
    {
        JSSVGPathSegCurvetoCubicRelConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegCurvetoCubicRelConstructor>(*exec->heap())) JSSVGPathSegCurvetoCubicRelConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegCurvetoCubicRelPrototype::s_info = { "SVGPathSegCurvetoCubicRelPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegCurvetoCubicRelPrototypeTable, 0 };
