...
public:
    ...
    {
        JSSVGDefsElementConstructor* ptr = new (JSC::allocateCell<JSSVGDefsElementConstructor>(*exec->heap())) JSSVGDefsElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGDefsElementPrototype::s_info = { "SVGDefsElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGDefsElementPrototypeTable, 0 };
