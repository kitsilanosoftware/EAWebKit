...
public:
    ...
    {
        JSSVGLengthListConstructor* ptr = new (JSC::allocateCell<JSSVGLengthListConstructor>(*exec->heap())) JSSVGLengthListConstructor(structure, globalObject);
...
const ClassInfo JSSVGLengthListPrototype::s_info = { "SVGLengthListPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGLengthListPrototypeTable, 0 };
