...
public:
    ...
    {
        JSSVGAngleConstructor* ptr = new (JSC::allocateCell<JSSVGAngleConstructor>(*exec->heap())) JSSVGAngleConstructor(structure, globalObject);
...
const ClassInfo JSSVGAnglePrototype::s_info = { "SVGAnglePrototype", &JSC::JSNonFinalObject::s_info, &JSSVGAnglePrototypeTable, 0 };
