...
public:
    ...
    {
        JSSQLResultSetRowList* ptr = new (JSC::allocateCell<JSSQLResultSetRowList>(globalObject->globalData().heap)) JSSQLResultSetRowList(structure, globalObject, impl);
...
public:
    ...
    {
        JSSQLResultSetRowListPrototype* ptr = new (JSC::allocateCell<JSSQLResultSetRowListPrototype>(globalData.heap)) JSSQLResultSetRowListPrototype(globalData, globalObject, structure);
