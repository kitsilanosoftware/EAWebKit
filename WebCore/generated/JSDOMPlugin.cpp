...
public:
    ...
    {
        JSDOMPluginConstructor* ptr = new (JSC::allocateCell<JSDOMPluginConstructor>(*exec->heap())) JSDOMPluginConstructor(structure, globalObject);
...
const ClassInfo JSDOMPluginPrototype::s_info = { "PluginPrototype", &JSC::JSNonFinalObject::s_info, &JSDOMPluginPrototypeTable, 0 };
