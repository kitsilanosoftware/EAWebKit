...
public:
    ...
    {
        JSCSSPrimitiveValue* ptr = new (JSC::allocateCell<JSCSSPrimitiveValue>(globalObject->globalData().heap)) JSCSSPrimitiveValue(structure, globalObject, impl);
...
public:
    ...
    {
        JSCSSPrimitiveValuePrototype* ptr = new (JSC::allocateCell<JSCSSPrimitiveValuePrototype>(globalData.heap)) JSCSSPrimitiveValuePrototype(globalData, globalObject, structure);
