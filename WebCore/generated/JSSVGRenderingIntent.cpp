...
public:
    ...
    {
        JSSVGRenderingIntentConstructor* ptr = new (JSC::allocateCell<JSSVGRenderingIntentConstructor>(*exec->heap())) JSSVGRenderingIntentConstructor(structure, globalObject);
...
const ClassInfo JSSVGRenderingIntentPrototype::s_info = { "SVGRenderingIntentPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGRenderingIntentPrototypeTable, 0 };
...
void JSSVGRenderingIntent::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSVGRenderingIntentPrototype::create(exec->globalData(), globalObject, JSSVGRenderingIntentPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
