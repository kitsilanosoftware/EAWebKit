...
public:
    ...
    {
        JSHTMLMarqueeElementConstructor* ptr = new (JSC::allocateCell<JSHTMLMarqueeElementConstructor>(*exec->heap())) JSHTMLMarqueeElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLMarqueeElementPrototype::s_info = { "HTMLMarqueeElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLMarqueeElementPrototypeTable, 0 };
