...
public:
    ...
    {
        JSMessageEventConstructor* ptr = new (JSC::allocateCell<JSMessageEventConstructor>(*exec->heap())) JSMessageEventConstructor(structure, globalObject);
...
const ClassInfo JSMessageEventPrototype::s_info = { "MessageEventPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSMessageEventPrototypeTable };
...
void JSMessageEvent::visitChildren(SlotVisitor& visitor)
{
    ASSERT_GC_OBJECT_INHERITS(this, &s_info);
