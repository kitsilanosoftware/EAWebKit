...
public:
    ...
    {
        JSHTMLKeygenElementConstructor* ptr = new (JSC::allocateCell<JSHTMLKeygenElementConstructor>(*exec->heap())) JSHTMLKeygenElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLKeygenElementPrototype::s_info = { "HTMLKeygenElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLKeygenElementPrototypeTable, 0 };
