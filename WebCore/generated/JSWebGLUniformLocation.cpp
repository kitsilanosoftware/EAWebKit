...
public:
    ...
    {
        JSWebGLUniformLocationConstructor* ptr = new (JSC::allocateCell<JSWebGLUniformLocationConstructor>(*exec->heap())) JSWebGLUniformLocationConstructor(structure, globalObject);
...
const ClassInfo JSWebGLUniformLocationPrototype::s_info = { "WebGLUniformLocationPrototype", &JSC::JSNonFinalObject::s_info, &JSWebGLUniformLocationPrototypeTable, 0 };
