...
public:
    ...
    {
        JSSVGFECompositeElementConstructor* ptr = new (JSC::allocateCell<JSSVGFECompositeElementConstructor>(*exec->heap())) JSSVGFECompositeElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFECompositeElementPrototype::s_info = { "SVGFECompositeElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFECompositeElementPrototypeTable, 0 };
