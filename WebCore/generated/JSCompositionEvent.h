...
public:
    ...
    {
        JSCompositionEvent* ptr = new (JSC::allocateCell<JSCompositionEvent>(globalObject->globalData().heap)) JSCompositionEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSCompositionEventPrototype* ptr = new (JSC::allocateCell<JSCompositionEventPrototype>(globalData.heap)) JSCompositionEventPrototype(globalData, globalObject, structure);
