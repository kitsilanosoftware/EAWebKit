...
public:
    ...
    {
        JSSVGViewElementConstructor* ptr = new (JSC::allocateCell<JSSVGViewElementConstructor>(*exec->heap())) JSSVGViewElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGViewElementPrototype::s_info = { "SVGViewElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGViewElementPrototypeTable, 0 };
...
JSValue jsSVGViewElementViewTarget(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    JSValue result = toJS(exec, castedThis->globalObject(), WTF::getPtr(SVGStaticListPropertyTearOff<SVGStringList>::create(imp, imp->viewTarget())));
    return result;
}
