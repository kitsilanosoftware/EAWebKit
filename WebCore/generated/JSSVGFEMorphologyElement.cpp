...
public:
    ...
    {
        JSSVGFEMorphologyElementConstructor* ptr = new (JSC::allocateCell<JSSVGFEMorphologyElementConstructor>(*exec->heap())) JSSVGFEMorphologyElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFEMorphologyElementPrototype::s_info = { "SVGFEMorphologyElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFEMorphologyElementPrototypeTable, 0 };
