...
public:
    ...
    {
        JSHTMLDivElementConstructor* ptr = new (JSC::allocateCell<JSHTMLDivElementConstructor>(*exec->heap())) JSHTMLDivElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLDivElementPrototype::s_info = { "HTMLDivElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLDivElementPrototypeTable, 0 };
