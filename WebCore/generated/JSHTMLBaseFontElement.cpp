...
public:
    ...
    {
        JSHTMLBaseFontElementConstructor* ptr = new (JSC::allocateCell<JSHTMLBaseFontElementConstructor>(*exec->heap())) JSHTMLBaseFontElementConstructor(structure, globalObject);
...
const ClassInfo JSHTMLBaseFontElementPrototype::s_info = { "HTMLBaseFontElementPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLBaseFontElementPrototypeTable, 0 };
