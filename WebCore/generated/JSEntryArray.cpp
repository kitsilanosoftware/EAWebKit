...
public:
    ...
    {
        JSEntryArrayConstructor* ptr = new (JSC::allocateCell<JSEntryArrayConstructor>(*exec->heap())) JSEntryArrayConstructor(structure, globalObject);
...
const ClassInfo JSEntryArrayPrototype::s_info = { "EntryArrayPrototype", &JSC::JSNonFinalObject::s_info, 0, getJSEntryArrayPrototypeTable };
