...
public:
    ...
    {
        JSCompositionEventConstructor* ptr = new (JSC::allocateCell<JSCompositionEventConstructor>(*exec->heap())) JSCompositionEventConstructor(structure, globalObject);
...
const ClassInfo JSCompositionEventPrototype::s_info = { "CompositionEventPrototype", &JSC::JSNonFinalObject::s_info, &JSCompositionEventPrototypeTable, 0 };
