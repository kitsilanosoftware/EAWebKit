...
public:
    ...
    {
        JSWorkerLocation* ptr = new (JSC::allocateCell<JSWorkerLocation>(globalObject->globalData().heap)) JSWorkerLocation(structure, globalObject, impl);
...
public:
    ...
    {
        JSWorkerLocationPrototype* ptr = new (JSC::allocateCell<JSWorkerLocationPrototype>(globalData.heap)) JSWorkerLocationPrototype(globalData, globalObject, structure);
