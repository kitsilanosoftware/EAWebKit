...
public:
    ...
    {
        JSSVGFontFaceUriElementConstructor* ptr = new (JSC::allocateCell<JSSVGFontFaceUriElementConstructor>(*exec->heap())) JSSVGFontFaceUriElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGFontFaceUriElementPrototype::s_info = { "SVGFontFaceUriElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGFontFaceUriElementPrototypeTable, 0 };
