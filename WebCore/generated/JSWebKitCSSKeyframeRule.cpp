...
public:
    ...
    {
        JSWebKitCSSKeyframeRuleConstructor* ptr = new (JSC::allocateCell<JSWebKitCSSKeyframeRuleConstructor>(*exec->heap())) JSWebKitCSSKeyframeRuleConstructor(structure, globalObject);
...
const ClassInfo JSWebKitCSSKeyframeRulePrototype::s_info = { "WebKitCSSKeyframeRulePrototype", &JSC::JSNonFinalObject::s_info, &JSWebKitCSSKeyframeRulePrototypeTable, 0 };
