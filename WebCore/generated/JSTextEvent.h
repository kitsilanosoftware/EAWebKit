...
public:
    ...
    {
        JSTextEvent* ptr = new (JSC::allocateCell<JSTextEvent>(globalObject->globalData().heap)) JSTextEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSTextEventPrototype* ptr = new (JSC::allocateCell<JSTextEventPrototype>(globalData.heap)) JSTextEventPrototype(globalData, globalObject, structure);
