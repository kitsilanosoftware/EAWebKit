...
public:
    ...
    {
        JSPositionError* ptr = new (JSC::allocateCell<JSPositionError>(globalObject->globalData().heap)) JSPositionError(structure, globalObject, impl);
...
public:
    ...
    {
        JSPositionErrorPrototype* ptr = new (JSC::allocateCell<JSPositionErrorPrototype>(globalData.heap)) JSPositionErrorPrototype(globalData, globalObject, structure);
