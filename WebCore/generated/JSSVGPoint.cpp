...
public:
    ...
    {
        JSSVGPointConstructor* ptr = new (JSC::allocateCell<JSSVGPointConstructor>(*exec->heap())) JSSVGPointConstructor(structure, globalObject);
...
const ClassInfo JSSVGPointPrototype::s_info = { "SVGPointPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPointPrototypeTable, 0 };
