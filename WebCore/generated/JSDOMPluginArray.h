...
public:
    ...
    {
        JSDOMPluginArray* ptr = new (JSC::allocateCell<JSDOMPluginArray>(globalObject->globalData().heap)) JSDOMPluginArray(structure, globalObject, impl);
...
public:
    ...
    {
        JSDOMPluginArrayPrototype* ptr = new (JSC::allocateCell<JSDOMPluginArrayPrototype>(globalData.heap)) JSDOMPluginArrayPrototype(globalData, globalObject, structure);
