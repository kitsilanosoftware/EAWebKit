...
public:
    ...
    {
        JSSVGPathSegCurvetoQuadraticRel* ptr = new (JSC::allocateCell<JSSVGPathSegCurvetoQuadraticRel>(globalObject->globalData().heap)) JSSVGPathSegCurvetoQuadraticRel(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPathSegCurvetoQuadraticRelPrototype* ptr = new (JSC::allocateCell<JSSVGPathSegCurvetoQuadraticRelPrototype>(globalData.heap)) JSSVGPathSegCurvetoQuadraticRelPrototype(globalData, globalObject, structure);
