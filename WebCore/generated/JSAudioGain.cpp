...
public:
    ...
    {
        JSAudioGainConstructor* ptr = new (JSC::allocateCell<JSAudioGainConstructor>(*exec->heap())) JSAudioGainConstructor(structure, globalObject);
...
const ClassInfo JSAudioGainPrototype::s_info = { "AudioGainPrototype", &JSC::JSNonFinalObject::s_info, &JSAudioGainPrototypeTable, 0 };
