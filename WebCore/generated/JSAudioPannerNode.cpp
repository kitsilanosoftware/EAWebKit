...
public:
    ...
    {
        JSAudioPannerNodeConstructor* ptr = new (JSC::allocateCell<JSAudioPannerNodeConstructor>(*exec->heap())) JSAudioPannerNodeConstructor(structure, globalObject);
...
const ClassInfo JSAudioPannerNodePrototype::s_info = { "AudioPannerNodePrototype", &JSC::JSNonFinalObject::s_info, &JSAudioPannerNodePrototypeTable, 0 };
