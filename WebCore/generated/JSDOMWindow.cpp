...
//+EAWebKitChange
//10/14/2011
// Put some guards around the features that we don't plan to use in order to disable them.
//-EAWebKitChange
...
static const HashTableValue JSDOMWindowTableValues[] =
{
    ...
    { "performance", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowPerformance), (intptr_t)setJSDOMWindowPerformance THUNK_GENERATOR(0) },
#endif
...
#endif
#if ENABLE(MEDIA_STREAM)
    { "webkitPeerConnection", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowWebkitPeerConnectionConstructor), (intptr_t)setJSDOMWindowWebkitPeerConnectionConstructor THUNK_GENERATOR(0) },
#endif
    ...
    { "HTMLSpanElement", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowHTMLSpanElementConstructor), (intptr_t)setJSDOMWindowHTMLSpanElementConstructor THUNK_GENERATOR(0) },
    ...
    { "HTMLUnknownElement", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowHTMLUnknownElementConstructor), (intptr_t)setJSDOMWindowHTMLUnknownElementConstructor THUNK_GENERATOR(0) },
    ...
    { "Float64Array", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowFloat64ArrayConstructor), (intptr_t)setJSDOMWindowFloat64ArrayConstructor THUNK_GENERATOR(0) },
    ...
    { "CompositionEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowCompositionEventConstructor), (intptr_t)setJSDOMWindowCompositionEventConstructor THUNK_GENERATOR(0) },
    { "CustomEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowCustomEventConstructor), (intptr_t)setJSDOMWindowCustomEventConstructor THUNK_GENERATOR(0) },
    { "ErrorEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowErrorEventConstructor), (intptr_t)setJSDOMWindowErrorEventConstructor THUNK_GENERATOR(0) },
    ...
    { "PopStateEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowPopStateEventConstructor), (intptr_t)setJSDOMWindowPopStateEventConstructor THUNK_GENERATOR(0) },
    ...
    { "XMLHttpRequestProgressEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowXMLHttpRequestProgressEventConstructor), (intptr_t)setJSDOMWindowXMLHttpRequestProgressEventConstructor THUNK_GENERATOR(0) },
#if ENABLE(SVG)
...
#endif
#if ENABLE(WEB_SOCKETS)
    { "CloseEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowCloseEventConstructor), (intptr_t)setJSDOMWindowCloseEventConstructor THUNK_GENERATOR(0) },
#endif
#if ENABLE(DOM_STORAGE)
...
#endif
#if ENABLE(WEB_AUDIO)
    { "AudioProcessingEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowAudioProcessingEventConstructor), (intptr_t)setJSDOMWindowAudioProcessingEventConstructor THUNK_GENERATOR(0) },
#endif
#if ENABLE(WEB_AUDIO)
    { "OfflineAudioCompletionEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowOfflineAudioCompletionEventConstructor), (intptr_t)setJSDOMWindowOfflineAudioCompletionEventConstructor THUNK_GENERATOR(0) },
#endif
#if ENABLE(INPUT_SPEECH)
    { "SpeechInputEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowSpeechInputEventConstructor), (intptr_t)setJSDOMWindowSpeechInputEventConstructor THUNK_GENERATOR(0) },
#endif
#if ENABLE(MEDIA_STREAM)
    { "MediaStreamEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowMediaStreamEventConstructor), (intptr_t)setJSDOMWindowMediaStreamEventConstructor THUNK_GENERATOR(0) },
#endif
#if ENABLE(WEBGL)
    { "WebGLContextEvent", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowWebGLContextEventConstructor), (intptr_t)setJSDOMWindowWebGLContextEventConstructor THUNK_GENERATOR(0) },
#endif
...
#endif
#if ENABLE(VIDEO)
    { "HTMLSourceElement", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowHTMLSourceElementConstructor), (intptr_t)setJSDOMWindowHTMLSourceElementConstructor THUNK_GENERATOR(0) },
#endif
#if ENABLE(XPATH)
    ...
    { "SVGAnimateMotionElement", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowSVGAnimateMotionElementConstructor), (intptr_t)setJSDOMWindowSVGAnimateMotionElementConstructor THUNK_GENERATOR(0) },
    ...
    { "SVGMPathElement", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowSVGMPathElementConstructor), (intptr_t)setJSDOMWindowSVGMPathElementConstructor THUNK_GENERATOR(0) },
...
static JSC_CONST_HASHTABLE HashTable JSDOMWindowTable = { 1122, 1023, JSDOMWindowTableValues, 0 };
...
public:
    ...
    {
        JSDOMWindowConstructor* ptr = new (JSC::allocateCell<JSDOMWindowConstructor>(*exec->heap())) JSDOMWindowConstructor(structure, globalObject);
...
// -EAWebKitChange
	{ "webkitRequestAnimationFrame", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsDOMWindowPrototypeFunctionWebkitRequestAnimationFrame), (intptr_t)2 THUNK_GENERATOR(0) },
    { "webkitCancelRequestAnimationFrame", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsDOMWindowPrototypeFunctionWebkitCancelRequestAnimationFrame), (intptr_t)1 THUNK_GENERATOR(0) },
// +EAWebKitChange
#endif
// -EAWebKitChange
...
#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSDOMWindowPrototypeTable = { 135, 127, JSDOMWindowPrototypeTableValues, 0 };
const ClassInfo JSDOMWindowPrototype::s_info = { "DOMWindowPrototype", &JSC::JSNonFinalObject::s_info, &JSDOMWindowPrototypeTable, 0 };
...
#if ENABLE(WEB_TIMING)
JSValue jsDOMWindowPerformance(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(asObject(slotBase));
    if (!castedThis->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(exec);
    DOMWindow* imp = static_cast<DOMWindow*>(castedThis->impl());
    JSValue result = toJS(exec, castedThis->globalObject(), WTF::getPtr(imp->performance()));
    return result;
}
#endif
...
#if ENABLE(MEDIA_STREAM)
JSValue jsDOMWindowWebkitPeerConnectionConstructor(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(asObject(slotBase));
    if (!castedThis->allowsAccessFrom(exec))
        return jsUndefined();
    return JSPeerConnection::getConstructor(exec, castedThis);
}
...
JSValue jsDOMWindowFloat64ArrayConstructor(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    if (!castedThis->allowsAccessFrom(exec))
        return jsUndefined();
    return castedThis->float64Array(exec);
}
...
void setJSDOMWindowPerformance(ExecState* exec, JSObject* thisObject, JSValue value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    // Shadowing a built-in object
    static_cast<JSDOMWindow*>(thisObject)->putDirect(exec->globalData(), Identifier(exec, "performance"), value);
}
...
#if ENABLE(MEDIA_STREAM)
void setJSDOMWindowWebkitPeerConnectionConstructor(ExecState* exec, JSObject* thisObject, JSValue value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    // Shadowing a built-in constructor
    static_cast<JSDOMWindow*>(thisObject)->putDirect(exec->globalData(), Identifier(exec, "webkitPeerConnection"), value);
}
...
EncodedJSValue JSC_HOST_CALL jsDOMWindowPrototypeFunctionWebkitRequestAnimationFrame(ExecState* exec)
{
    ...
    JSC::JSValue result = jsNumber(imp->webkitRequestAnimationFrame(callback, element));
    return JSValue::encode(result);
}
