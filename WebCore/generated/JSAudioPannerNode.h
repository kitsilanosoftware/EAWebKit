...
public:
    ...
    {
        JSAudioPannerNode* ptr = new (JSC::allocateCell<JSAudioPannerNode>(globalObject->globalData().heap)) JSAudioPannerNode(structure, globalObject, impl);
...
public:
    ...
    {
        JSAudioPannerNodePrototype* ptr = new (JSC::allocateCell<JSAudioPannerNodePrototype>(globalData.heap)) JSAudioPannerNodePrototype(globalData, globalObject, structure);
