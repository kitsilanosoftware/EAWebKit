...
public:
    ...
    {
        JSHTMLCollectionConstructor* ptr = new (JSC::allocateCell<JSHTMLCollectionConstructor>(*exec->heap())) JSHTMLCollectionConstructor(structure, globalObject);
...
const ClassInfo JSHTMLCollectionPrototype::s_info = { "HTMLCollectionPrototype", &JSC::JSNonFinalObject::s_info, &JSHTMLCollectionPrototypeTable, 0 };
