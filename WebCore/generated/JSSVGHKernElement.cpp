...
public:
    ...
    {
        JSSVGHKernElementConstructor* ptr = new (JSC::allocateCell<JSSVGHKernElementConstructor>(*exec->heap())) JSSVGHKernElementConstructor(structure, globalObject);
...
const ClassInfo JSSVGHKernElementPrototype::s_info = { "SVGHKernElementPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGHKernElementPrototypeTable, 0 };
