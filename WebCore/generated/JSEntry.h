...
public:
    ...
    {
        JSEntry* ptr = new (JSC::allocateCell<JSEntry>(globalObject->globalData().heap)) JSEntry(structure, globalObject, impl);
...
public:
    ...
    {
        JSEntryPrototype* ptr = new (JSC::allocateCell<JSEntryPrototype>(globalData.heap)) JSEntryPrototype(globalData, globalObject, structure);
