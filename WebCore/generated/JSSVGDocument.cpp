...
public:
    ...
    {
        JSSVGDocumentConstructor* ptr = new (JSC::allocateCell<JSSVGDocumentConstructor>(*exec->heap())) JSSVGDocumentConstructor(structure, globalObject);
...
const ClassInfo JSSVGDocumentPrototype::s_info = { "SVGDocumentPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGDocumentPrototypeTable, 0 };
