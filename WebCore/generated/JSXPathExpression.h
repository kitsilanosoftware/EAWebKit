...
public:
    ...
    {
        JSXPathExpression* ptr = new (JSC::allocateCell<JSXPathExpression>(globalObject->globalData().heap)) JSXPathExpression(structure, globalObject, impl);
...
public:
    ...
    {
        JSXPathExpressionPrototype* ptr = new (JSC::allocateCell<JSXPathExpressionPrototype>(globalData.heap)) JSXPathExpressionPrototype(globalData, globalObject, structure);
