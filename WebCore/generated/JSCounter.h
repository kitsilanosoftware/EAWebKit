...
public:
    ...
    {
        JSCounter* ptr = new (JSC::allocateCell<JSCounter>(globalObject->globalData().heap)) JSCounter(structure, globalObject, impl);
...
public:
    ...
    {
        JSCounterPrototype* ptr = new (JSC::allocateCell<JSCounterPrototype>(globalData.heap)) JSCounterPrototype(globalData, globalObject, structure);
