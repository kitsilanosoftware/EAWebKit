...
public:
    ...
    {
        JSDeviceMotionEventConstructor* ptr = new (JSC::allocateCell<JSDeviceMotionEventConstructor>(*exec->heap())) JSDeviceMotionEventConstructor(structure, globalObject);
...
const ClassInfo JSDeviceMotionEventPrototype::s_info = { "DeviceMotionEventPrototype", &JSC::JSNonFinalObject::s_info, &JSDeviceMotionEventPrototypeTable, 0 };
