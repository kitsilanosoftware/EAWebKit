...
public:
    ...
    {
        JSArrayBufferView* ptr = new (JSC::allocateCell<JSArrayBufferView>(globalObject->globalData().heap)) JSArrayBufferView(structure, globalObject, impl);
...
public:
    ...
    {
        JSArrayBufferViewPrototype* ptr = new (JSC::allocateCell<JSArrayBufferViewPrototype>(globalData.heap)) JSArrayBufferViewPrototype(globalData, globalObject, structure);
