...
public:
    ...
    {
        JSSVGAnimatedPreserveAspectRatio* ptr = new (JSC::allocateCell<JSSVGAnimatedPreserveAspectRatio>(globalObject->globalData().heap)) JSSVGAnimatedPreserveAspectRatio(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnimatedPreserveAspectRatioPrototype* ptr = new (JSC::allocateCell<JSSVGAnimatedPreserveAspectRatioPrototype>(globalData.heap)) JSSVGAnimatedPreserveAspectRatioPrototype(globalData, globalObject, structure);
