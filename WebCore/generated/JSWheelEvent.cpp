...
public:
    ...
    {
        JSWheelEventConstructor* ptr = new (JSC::allocateCell<JSWheelEventConstructor>(*exec->heap())) JSWheelEventConstructor(structure, globalObject);
...
const ClassInfo JSWheelEventPrototype::s_info = { "WheelEventPrototype", &JSC::JSNonFinalObject::s_info, &JSWheelEventPrototypeTable, 0 };
