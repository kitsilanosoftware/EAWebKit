...
public:
    ...
    {
        JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor* ptr = new (JSC::allocateCell<JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor>(*exec->heap())) JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor(structure, globalObject);
...
const ClassInfo JSSVGPathSegCurvetoQuadraticSmoothAbsPrototype::s_info = { "SVGPathSegCurvetoQuadraticSmoothAbsPrototype", &JSC::JSNonFinalObject::s_info, &JSSVGPathSegCurvetoQuadraticSmoothAbsPrototypeTable, 0 };
