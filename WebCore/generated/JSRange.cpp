...
public:
    ...
    {
        JSRangeConstructor* ptr = new (JSC::allocateCell<JSRangeConstructor>(*exec->heap())) JSRangeConstructor(structure, globalObject);
...
const ClassInfo JSRangePrototype::s_info = { "RangePrototype", &JSC::JSNonFinalObject::s_info, &JSRangePrototypeTable, 0 };
