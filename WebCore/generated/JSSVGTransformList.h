...
public:
    ...
    {
        JSSVGTransformList* ptr = new (JSC::allocateCell<JSSVGTransformList>(globalObject->globalData().heap)) JSSVGTransformList(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGTransformListPrototype* ptr = new (JSC::allocateCell<JSSVGTransformListPrototype>(globalData.heap)) JSSVGTransformListPrototype(globalData, globalObject, structure);
